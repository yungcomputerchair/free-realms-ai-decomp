// addr: 0x013cdbf0
// name: ComponentFactory_findOrInsertFactorySlot_impl
// subsystem: common/game/match
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Removing unreachable block (ram,0x013cddea) */
/* WARNING: Removing unreachable block (ram,0x013cdd74) */
/* WARNING: Removing unreachable block (ram,0x013cded3) */
/* Setting prototype: void ComponentFactory_findOrInsertFactorySlot(void * this, int * outIter, uint
   * key) */

void __thiscall ComponentFactory_findOrInsertFactorySlot_impl(void *this,int *outIter,uint *key)

{
  ...
  undefined8 uVar11;
                    ...
                    /* Finds or inserts a factory slot in ComponentFactory's integer hash table,
                       rehashing buckets when needed and returning the slot for the key. */
  ...
  if (uVar9 <= *(uint *)((int)this + 0xc) >> 2) {
    ...
    if (uVar9 < iVar5 - 1U) {
      ...
      *(int *)((int)this + 0x20) = iVar6 * 2 + -3;
      FUN_013cd740(*(int *)((int)this + 0x20) + 2,(int)this + 4,*(undefined4 *)((int)this + 8));
    }
...
LAB_013cdef1:
  ...
  do {
    ...
    if (*(undefined4 **)(*(int *)((int)this + 0x14) + 4 + uVar9 * 8) == puVar8) goto LAB_013cdffd;
    if (iVar6 == 0) {
      FUN_00d83c2d();
    }
  ...
  puVar8 = (undefined4 *)*puVar8;
LAB_013cdffd:
  iVar5 = FUN_013cca00(puVar8,puVar8[1],key);
  FUN_013cd350(1);
  puVar8[1] = iVar5;
  **(int **)(iVar5 + 4) = iVar5;
  if (iVar6 == 0) {
