...
/* Setting prototype: void dispatchToNestedChildren34(int object_, undefined4 arg_) */

void __thiscall dispatchToNestedChildren34(void *this,int object_,undefined4 arg_)
