// addr: 0x014cbfa0
// name: LobbyCommand_BulkJoin_dtor
// subsystem: common/game/match
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void LobbyCommand_BulkJoin_dtor(void * this) */

void __fastcall LobbyCommand_BulkJoin_dtor(void *this)

{
  ...
  int local_4;
                    ...
                    /* Destroys a LobbyCommand_BulkJoin: deletes owned pointer-vector entries, frees
                       several vector/string buffers, clears embedded buffers, then calls the
                       LobbyCommand base destructor. Evidence is the explicit
                       LobbyCommand_BulkJoin::vftable and LobbyCommand_dtor calls. */
  puStack_8 = &LAB_016ab585;
  ...
  *(undefined ***)this = LobbyCommand_BulkJoin::vftable;
  ...
  if (_Src < *(void **)((int)this + 0x5c)) {
    FUN_00d83c2d(uVar2);
  }
  _Dst = *(void **)((int)this + 0x5c);
  if (*(void **)((int)this + 0x60) < _Dst) {
    FUN_00d83c2d(uVar2);
  }
  if (_Dst != _Src) {
    iVar3 = *(int *)((int)this + 0x60) - (int)_Src >> 2;
    _DstSize = iVar3 * 4;
    if (0 < iVar3) {
      _memmove_s(_Dst,_DstSize,_Src,_DstSize);
    }
    *(void **)((int)this + 0x60) = (void *)(_DstSize + (int)_Dst);
  }
