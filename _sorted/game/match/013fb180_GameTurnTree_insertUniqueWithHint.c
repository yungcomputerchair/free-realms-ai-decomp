// addr: 0x013fb180
// name: GameTurnTree_insertUniqueWithHint
// subsystem: common/game/match
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * GameTurnTree_insertUniqueWithHint(void * this, void * outPair, void *
   hintContainer, void * hintNode, int * key) */

void * __thiscall
GameTurnTree_insertUniqueWithHint
...

{
  ...
  if (*(int *)((int)this + 8) == 0) {
    FUN_013fa640(outPair,1,*(undefined4 *)((int)this + 4),key);
    return outPair;
  }
  ...
  if (hintNode == pvVar1) {
    if (*key < *(int *)((int)hintNode + 0xc)) {
      FUN_013fa640(outPair,1,hintNode,key);
      return outPair;
    }
  }
  else {
    ...
    if (hintNode == pvVar1) {
      ...
      if (*(int *)(iVar2 + 0xc) < *key) {
        FUN_013fa640(outPair,0,iVar2,key);
        return outPair;
      }
    }
    else {
      ...
      if (iVar2 < iVar3) {
        ...
        if (*(int *)((int)hintNode + 0xc) < iVar4) {
          if (*(char *)(*(int *)((int)hintNode + 8) + 0x15) != '\0') {
            FUN_013fa640(outPair,0,hintNode,key);
            return outPair;
          }
          FUN_013fa640(outPair,1,hintNode,key);
          return outPair;
  ...
  puVar6 = (undefined4 *)FUN_013fb020(&local_c,key);
