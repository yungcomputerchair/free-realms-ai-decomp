// addr: 0x00fe2b50
// name: AppPhysics_RigidBody_setWorldTransform
// subsystem: common/physics/vehicle
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void AppPhysics_RigidBody_setWorldTransform(void * this, float * transform) */

void __thiscall AppPhysics_RigidBody_setWorldTransform(void *this,float *transform)

{
  ...
  undefined1 local_50 [76];
                    ...
                    /* Builds a Bullet transform from the supplied matrix, applies it to the
                       underlying rigid body, and clears interpolation/velocity state when the body
                       is not in the simple state; unlike 00fe2850 it does not notify the motion
                       state. */
