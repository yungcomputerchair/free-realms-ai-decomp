...
void * __fastcall UChatCommand_OnReceiveFriendConfirmRequest_registerFactory(void *registry)

{
  ...
  local_4 = 0;
  if (this != (void *)0x0) {
    pvVar2 = UChatCommand_OnReceiveFriendConfirmRequest_ctor(this);
  }
  local_4 = 0xffffffff;
