...

{
  ...
  undefined4 uStack_4;
                    ...
                    /* Replaces the player movement controller with a newly allocated 0x30-byte
                       controller, guarded by movement update toggles. Exact controller class is not
                       named. */
  uStack_4 = 0xffffffff;
  puStack_8 = &LAB_0159670b;
  ...
  *(undefined4 *)((int)this + 0x3fc) = 0;
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    uVar2 = ProxiedCharacterRailMovementController_ctor(this,player,param_2,in_stack_0000000c);
  }
  uStack_4 = 0xffffffff;
