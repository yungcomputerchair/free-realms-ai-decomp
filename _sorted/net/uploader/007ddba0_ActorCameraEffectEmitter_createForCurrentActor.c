...
/* Setting prototype: void * ActorCameraEffectEmitter_createForCurrentActor(void) */
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Gets the current actor/effect context, allocates and constructs
                       ActorCameraEffectEmitter, then initializes it with the matching emitter setup
                       helper. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_01562b6b;
  ...
  if ((extraout_EAX != 0) && (*(char *)(extraout_EAX + 0x22d) != '\0')) {
    ...
    if (pvVar1 == (void *)0x0) {
      ...
      pvVar1 = ActorCameraEffectEmitter_ctor(pvVar1,*(void **)(extraout_EAX + 0x360));
    }
    local_4 = 0xffffffff;
    FUN_007c1180();
    ExceptionList = local_c;
