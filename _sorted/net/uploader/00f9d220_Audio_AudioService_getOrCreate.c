// addr: 0x00f9d220
// name: Audio_AudioService_getOrCreate
// subsystem: common/net/uploader
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined * __fastcall Audio_AudioService_getOrCreate(int param_1)

{
  ...
  undefined4 local_4;
                    ...
                    /* Service registry accessor that returns the existing AudioService or
                       constructs/registers one on miss. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0162a9eb;
  local_c = ExceptionList;
  uVar2 = DAT_01b839d8 ^ (uint)&stack0xffffffcc;
  ExceptionList = &local_c;
  local_24 = &DAT_01cbd704;
  ...
  if (local_1c == (undefined *)iVar1) {
    local_24 = Mem_Alloc(0x48);
    puVar3 = (undefined *)0x0;
    local_4 = 0;
    if (local_24 != (undefined *)0x0) {
      puVar3 = (undefined *)FUN_00f9ae10();
    }
    local_4 = 0xffffffff;
    local_20 = &DAT_01cbd704;
    local_1c = puVar3;
