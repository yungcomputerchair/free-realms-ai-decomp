...

{
  ...
  if (*(char *)((int)this + 0x70) == '\0') {
    ...
    bVar1 = CountryCodesRequest_hasRequiredFields((int)callback);
    if (bVar1) {
      pvVar3 = Mem_Alloc(0x4a8);
      local_4 = 0;
      if (pvVar3 == (void *)0x0) {
        uVar4 = 0;
      }
      else {
        uVar4 = FUN_00f63de0(request,callback,(int)this + 0x4c,(int)this + 0x5c,
