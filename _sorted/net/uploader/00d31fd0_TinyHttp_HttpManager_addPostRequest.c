// addr: 0x00d31fd0
// name: TinyHttp_HttpManager_addPostRequest
// subsystem: common/net/uploader
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


void __thiscall
TinyHttp_HttpManager_addPostRequest
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Allocates and constructs a TinyHttp::HttpManager::PostRequest, links it into
                       the manager request list, increments count, and accumulates request size.
                       Evidence is the callee constructor assigning
                       TinyHttp::HttpManager::PostRequest::vftable. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0161323b;
  ...
  if (pvVar1 == (void *)0x0) {
    ...
    iVar2 = FUN_00d31c60(param_1,param_2,param_3,param_4,param_5);
  }
