// addr: 0x00f9ce10
// name: Streaming_StreamingService_getOrCreate
// subsystem: common/net/uploader
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined * __fastcall Streaming_StreamingService_getOrCreate(int param_1)

{
  ...
  undefined4 local_4;
                    ...
                    /* Service registry accessor that returns the existing StreamingService or
                       constructs/registers one on miss. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0162a92b;
  local_c = ExceptionList;
  uVar2 = DAT_01b839d8 ^ (uint)&stack0xffffffcc;
  ExceptionList = &local_c;
  local_24 = &DAT_01cbd8f0;
  ...
  if (local_1c == (undefined *)iVar1) {
    local_24 = Mem_Alloc(0x18);
    puVar3 = (undefined *)0x0;
    local_4 = 0;
    if (local_24 != (undefined *)0x0) {
      puVar3 = Streaming_StreamingService_ctor(local_24);
    }
    local_4 = 0xffffffff;
    local_20 = &DAT_01cbd8f0;
    local_1c = puVar3;
