// addr: 0x00911130
// name: LobbyGame_deserialize
// subsystem: common/client/baseclient
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void LobbyGame_deserialize(void * this, void * reader) */

void __thiscall LobbyGame_deserialize(void *this,void *reader)

{
  undefined4 *puVar1;
  
                    /* Deserializes a LobbyGame-like record from a bounded reader: several dwords, a
                       nested string/list field, a bool, a 64-bit value, and trailing status fields.
                        */
  ...
  if (*(undefined4 **)((int)reader + 0xc) < *(undefined4 **)((int)reader + 8) + 1) {
    ...
    *(undefined4 *)((int)this + 0x3c) = **(undefined4 **)((int)reader + 8);
    *(int *)((int)reader + 8) = *(int *)((int)reader + 8) + 4;
  }
  if (*(undefined4 **)((int)reader + 0xc) < *(undefined4 **)((int)reader + 8) + 1) {
    ...
    *(undefined4 *)((int)this + 0x60) = **(undefined4 **)((int)reader + 8);
    *(int *)((int)reader + 8) = *(int *)((int)reader + 8) + 4;
  }
  deserializeDwordPairList(reader);
  FUN_008e7290(reader);
  if (*(char **)((int)reader + 0xc) < *(char **)((int)reader + 8) + 1) {
    ...
    *(bool *)((int)this + 0x46) = **(char **)((int)reader + 8) != '\0';
  ...
  if (*(undefined4 **)((int)reader + 0xc) < *(undefined4 **)((int)reader + 8) + 1) {
    ...
    *(undefined4 *)((int)this + 0x48) = **(undefined4 **)((int)reader + 8);
    *(int *)((int)reader + 8) = *(int *)((int)reader + 8) + 4;
  }
  ...
  if (*(undefined4 **)((int)reader + 0xc) < *(undefined4 **)((int)reader + 8) + 1) {
    ...
    *(undefined4 *)((int)this + 0x104) = **(undefined4 **)((int)reader + 8);
    *(int *)((int)reader + 8) = *(int *)((int)reader + 8) + 4;
  }
  if (*(char **)((int)reader + 0xc) < *(char **)((int)reader + 8) + 1) {
  ...
  *(bool *)((int)this + 0x108) = **(char **)((int)reader + 8) != '\0';
  *(int *)((int)reader + 8) = *(int *)((int)reader + 8) + 1;
  return;
}
