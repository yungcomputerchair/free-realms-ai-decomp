// addr: 0x010cd6c0
// name: GuiDataSource_notifyTreeCtrlsNodeChanged
// subsystem: common/client/ui
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void GuiDataSource_notifyTreeCtrlsNodeChanged(void * this, void * node) */

void __thiscall GuiDataSource_notifyTreeCtrlsNodeChanged(void *this,void *node)

{
  ...
  int *piVar5;
                    ...
                    /* When notifications are enabled, traverses observers, finds GuiTreeCtrl
                       observers, sends a node-change event for the provided node, and triggers a UI
                       update code 7. Exact data-source subclass is unknown. */
  ...
  while ((cVar1 != '\0' && (piVar5 != (int *)0x0))) {
    if ((*piVar5 != 0) &&
      ...
      GuiTreeCtrl_onDataSourceRowsChanged
                (*(void **)(iVar4 + 0x150),2,(uint)node,0,0,0,(void *)0x0,(void *)0x0,(void *)0x0,
                 false);
      FUN_00411506(7);
    }
    piVar2 = (int *)piVar5[4];
