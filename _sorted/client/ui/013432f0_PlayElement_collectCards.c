...

{
  ...
  undefined1 local_10 [12];
                    ...
                    /* Walks nested PlayElement collections, dynamic_casts entries to Card, appends
                       Card pointers to the output vector, and recurses through child containers.
                       Evidence is PlayElement/Card RTTI and vector append helper. */
