...

{
  ...
  undefined4 local_4;
                    ...
                    /* Small template/inline wrapper constructs an InstanceID and appends it to a
                       vector. Evidence is calls to InstanceID_ctor, vector push helper 012c3e50,
                       and InstanceID_dtor. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016a4e48;
