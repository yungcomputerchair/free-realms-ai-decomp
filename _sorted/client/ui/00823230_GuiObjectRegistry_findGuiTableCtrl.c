// addr: 0x00823230
// name: GuiObjectRegistry_findGuiTableCtrl
// subsystem: common/client/ui
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * GuiObjectRegistry_findGuiTableCtrl(char * name) */

void * __cdecl GuiObjectRegistry_findGuiTableCtrl(char *name)

{
  ...
  void *local_4;
                    ...
                    /* Hashes a UI object name, looks it up in the object registry, and casts the
                       found GObject to GuiTableCtrl. Returns null on miss or failed cast. */
  outObject = &local_4;
  local_4 = (void *)0x0;
