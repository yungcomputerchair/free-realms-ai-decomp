// addr: 0x00a445c0
// name: AdventurersJournalStickerDefinition_deserialize
// subsystem: common/client/journal
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void AdventurersJournalStickerDefinition_deserialize(void * this, void *
   reader) */

void __thiscall AdventurersJournalStickerDefinition_deserialize(void *this,void *reader)

{
                    /* Reads nine 32-bit fields for a sticker definition from the packet reader and
