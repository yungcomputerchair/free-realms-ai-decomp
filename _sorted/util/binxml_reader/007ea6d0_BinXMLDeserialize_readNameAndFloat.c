// addr: 0x007ea6d0
// name: BinXMLDeserialize_readNameAndFloat
// subsystem: common/util/binxml_reader
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


int __thiscall BinXMLDeserialize_readNameAndFloat(int param_1,void *param_2)

{
  ...
  reader = param_2;
                    /* Reads element 1 as a string temporary and element 2 as a float stored at
                       offset 0x14. The owning class/name is not evident. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_01564dd0;
