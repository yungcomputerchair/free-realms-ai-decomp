// addr: 0x00f52880
// name: init_all_odd_diag
// subsystem: common/util/misc
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* private: void __thiscall Chess::init_all_odd_diag(unsigned __int64 *) */

void __thiscall Chess::init_all_odd_diag(Chess *this,__uint64 *param_1)

{
  ...
  undefined8 uVar3;
                    ...
                    /* Preserves the existing identified symbol init_all_odd_diag; code initializes
