...
byte FUN_0046be93(int param_1,undefined4 param_2,int *param_3,int *param_4,int param_5)

{
  ...
  int local_8;
                    ...
                    /* Updates a rectangular region/paint node for another branch of a region
                       operation, lazily creating an accumulation region and merging bounds. Exact
                       class evidence absent. */
  if (*(void **)(param_1 + 0xc) == (void *)0x0) {
    if (param_5 != 1) {
      ...
      if (CONCAT31(extraout_var,cVar3) != 1) goto LAB_0046bedf;
      uVar5 = FUN_00466ce6();
      *(undefined4 *)(param_1 + 0xc) = uVar5;
      FUN_004dbd55(param_4[2]);
    }
LAB_0046bfdb:
    FUN_00465221(param_2);
    local_48 = local_48 + *param_4;
    local_40 = local_40 + *param_4;
    local_44 = local_44 + param_4[1];
    local_3c = local_3c + param_4[1];
    cVar3 = FUN_00465656(param_1,&local_48,0);
    if (cVar3 == '\0') {
    ...
    if (param_5 == 1) {
      ...
      if (CONCAT31(extraout_var_02,cVar3) == 1) goto LAB_0046bfdb;
    }
    else {
      local_14 = *(int *)(param_1 + 0x10);
      local_10 = *(int *)(param_1 + 0x14);
