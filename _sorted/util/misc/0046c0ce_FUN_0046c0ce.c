...
int FUN_0046c0ce(int param_1,int param_2,int param_3,undefined4 *param_4,int param_5)

{
  ...
  if ((*(int *)(param_1 + 0xc) == 0) || (iVar6 = FUN_004f7dfd(param_3), iVar6 == 1)) {
    if (param_5 != 1) {
      ...
      if (CONCAT31(extraout_var,cVar3) != 1) goto LAB_0046c116;
    }
    iVar6 = *(int *)(param_2 + 8);
    local_8 = FUN_00465699(param_1,param_2,*param_4,param_4[1],0);
