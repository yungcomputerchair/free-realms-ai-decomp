...
/* Setting prototype: undefined4 * GameCommand_OfferAdjournment_ctor(undefined4 * param_1,
   undefined4 param_2_) */

undefined4 * __thiscall
GameCommand_OfferAdjournment_ctor(void *this,undefined4 *param_1,undefined4 param_2_)
