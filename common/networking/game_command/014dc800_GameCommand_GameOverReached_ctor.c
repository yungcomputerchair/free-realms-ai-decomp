...
/* Setting prototype: undefined4 * GameCommand_GameOverReached_ctor(undefined4 * param_1, undefined4
   param_2_) */

undefined4 * __thiscall
GameCommand_GameOverReached_ctor(void *this,undefined4 *param_1,undefined4 param_2_)
