// addr: 0x01371870
// name: Game_getOrCreateCardForID
...
int * __fastcall
Game_getOrCreateCardForID(void *param_1,int param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  undefined4 local_4;
                    ...
                    /* Returns an existing Card for an element id or creates one, reporting an
                       Exception if the element is missing. Evidence is the embedded Game.cpp
                       message "Couldn't get card from element may in getOrCreateCardForForID!" and
                       the 'Card: %d, player: %d' diagnostic. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_01680dbd;
  ...
  if (pvVar2 == (void *)0x0) {
    ...
    std::basic_string<char,std::char_traits<char>,std::allocator<char>_>::assign
              (local_434,"Couldn\'t get card from element may in getOrCreateCardForForID!",0x3e);
    local_4 = 1;
    ...
    local_4 = 0xffffffff;
    (**(code **)(*piVar4 + 0x44))(param_1,param_4);
  }
  else {
