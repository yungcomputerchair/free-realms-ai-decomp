// addr: 0x013bad20
// name: UChatCommand_RequestFriendStatus_assignStatusVector
// subsystem: common/networking/uchat_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int UChatCommand_RequestFriendStatus_assignStatusVector(void * thisVector,
   void * sourceVector) */

int __thiscall
UChatCommand_RequestFriendStatus_assignStatusVector(void *this,void *thisVector,void *sourceVector)

{
  ...
  uint uVar6;
                    ...
                    /* Assigns/copies the RequestFriendStatus int-vector payload, reallocating as
  ...
  if (iVar3 != 0) {
    ...
    if (uVar6 != 0) {
      ...
      if (uVar6 <= uVar4) {
        UChatCommand_RequestFriendStatus_copyIntRangeToBuffer
      ...
      if (uVar4 < uVar6) {
        ...
        cVar1 = FUN_013baa70(iVar3);
        if (cVar1 == '\0') {
          return (int)this;
        }
        uVar2 = UChatCommand_RequestFriendStatus_copyIntRange
      ...
      iVar5 = iVar3 + iVar5 * 4;
      UChatCommand_RequestFriendStatus_copyIntRangeToBuffer(iVar3,iVar5,_Memory);
      uVar2 = UChatCommand_RequestFriendStatus_copyIntRange
