// addr: 0x013bbe40
// name: UChatCommand_RequestIgnoreStatus_copyIntRangeToBuffer
// subsystem: common/networking/uchat_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


void * UChatCommand_RequestIgnoreStatus_copyIntRangeToBuffer
...

{
  ...
  int iVar1;
                    ...
                    /* Copies a non-empty range of 4-byte entries into a destination buffer and
                       returns the advanced destination pointer; used by RequestIgnoreStatus vector
                       assignment. */
