// addr: 0x014c6a60
// name: STLVector_int_serialize_014c6a60
// subsystem: common/networking/account_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int STLVector_int_serialize_014c6a60(void * writer, int vector) */

int __thiscall STLVector_int_serialize_014c6a60(void *this,void *writer,int vector)

{
  ...
  int unaff_EDI;
                    ...
                    /* Serializes a vector of 32-bit integers by writing the count, each element,
                       and a success terminator. */
  pvVar2 = writer;
