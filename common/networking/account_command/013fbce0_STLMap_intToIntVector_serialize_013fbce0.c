// addr: 0x013fbce0
// name: STLMap_intToIntVector_serialize_013fbce0
// subsystem: common/networking/account_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int STLMap_intToIntVector_serialize_013fbce0(void * writer, void * map) */

int __thiscall STLMap_intToIntVector_serialize_013fbce0(void *this,void *writer,void *map)

{
  ...
  undefined4 local_4;
                    ...
                    /* Serializes a further int-to-int-vector map instantiation by writing count and
                       then key plus integer-vector value for each tree node. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0168fd10;
