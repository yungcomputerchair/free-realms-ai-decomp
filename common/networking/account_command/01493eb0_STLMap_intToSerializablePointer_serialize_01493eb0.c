// addr: 0x01493eb0
// name: STLMap_intToSerializablePointer_serialize_01493eb0
// subsystem: common/networking/account_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int STLMap_intToSerializablePointer_serialize_01493eb0(void * writer, int map)
    */

int __thiscall STLMap_intToSerializablePointer_serialize_01493eb0(void *this,void *writer,int map)

{
  ...
  undefined4 local_c;
                    ...
                    /* Serializes a map from integer keys to serializable object pointers using the
                       shared key/object element serializer. */
