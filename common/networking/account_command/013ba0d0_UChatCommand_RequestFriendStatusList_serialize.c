// addr: 0x013ba0d0
// name: UChatCommand_RequestFriendStatusList_serialize
// subsystem: common/networking/account_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int UChatCommand_RequestFriendStatusList_serialize(void * this, int vector) */

int __thiscall UChatCommand_RequestFriendStatusList_serialize(void *this,int vector)

{
  ...
  int unaff_EDI;
                    ...
                    /* Serializes the request-friend-status list by writing a vector count and
