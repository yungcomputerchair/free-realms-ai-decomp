// addr: 0x013d6b50
// name: Poll_optionList_serialize
// subsystem: common/networking/account_command
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int Poll_optionList_serialize(void * this, int vector) */

int __thiscall Poll_optionList_serialize(void *this,int vector)

{
  ...
  int unaff_EDI;
                    ...
                    /* Serializes Poll's option/object list as a vector of serializable pointers. */
  iVar3 = vector;
  if (*(int *)(vector + 4) == 0) {
    serializer = 0;
  }
