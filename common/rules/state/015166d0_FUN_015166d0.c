...
void __thiscall FUN_015166d0(int *param_1,int *param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  undefined4 uStack_4;
                    ...
                    /* Schedules a CWActionPlayedState from a selected/played card, filling return
                       values and installing a copied CWActionPlayedState. It is behaviorally
                       identical to another helper but lacks class-identifying strings. */
  uStack_4 = 0xffffffff;
  puStack_8 = &LAB_016b7666;
