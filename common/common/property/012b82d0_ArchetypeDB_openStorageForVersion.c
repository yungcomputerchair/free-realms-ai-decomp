// addr: 0x012b82d0
// name: ArchetypeDB_openStorageForVersion
...
/* Setting prototype: void ArchetypeDB_openStorageForVersion(void * this, int version) */

void __thiscall ArchetypeDB_openStorageForVersion(void *this,int version)

{
  ...
  int iStack_4;
                    ...
                    /* Initializes DBM storage for an archetype database version if absent, opens
                       ./data/archetypes/<version>.dat, and resets index/load state. Evidence:
                       ArchetypeDB.cpp assert 'v != -1', './data/archetypes', storage allocation,
                       and clearing of a loaded flag. */
  iStack_4 = 0xffffffff;
  puStack_8 = &LAB_0166d75b;
  local_c = ExceptionList;
  local_10 = DAT_01b839d8 ^ (uint)&pvStack_58;
  key = (int *)(DAT_01b839d8 ^ (uint)&stack0xffffff98);
  ExceptionList = &local_c;
  if (version == -1) {
    FUN_012f5a60("v != -1","..\\common\\common\\property\\ArchetypeDB.cpp",0x346);
  }
  local_54 = *(int *)((int)this + 0x1c);
  ...
  if (extraout_EAX[1] == local_54) {
    ...
    *puVar2 = pvVar1;
    ...
    ArchetypeDB_PropertyValueMap_findOrInsertSecond(&version);
    ArchetypeDB_PropertyValueMap_findOrInsertFirst(&version);
    IntKeyBufferMap_findOrInsert(&version);
    pbVar3 = IntToBoolMap_getOrInsert((void *)((int)this + 0x30),&version,key);
    *pbVar3 = false;
    iStack_4 = 0xffffffff;
    if (0xf < uStack_14) {
                    /* WARNING: Subroutine does not return */
