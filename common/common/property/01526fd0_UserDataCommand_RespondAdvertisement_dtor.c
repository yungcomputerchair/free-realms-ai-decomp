// addr: 0x01526fd0
// name: UserDataCommand_RespondAdvertisement_dtor
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void UserDataCommand_RespondAdvertisement_dtor(void * this) */

void __fastcall UserDataCommand_RespondAdvertisement_dtor(void *this)

{
  ...
  undefined4 local_4;
                    ...
                    /* Destroys a RespondAdvertisement object by restoring its vtable and freeing
                       four owned string/vector-style member groups. */
  puStack_8 = &LAB_016b9494;
