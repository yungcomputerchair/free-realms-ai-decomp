// addr: 0x014dfdf0
// name: GameCommand_CardPlayed_deserialize
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: uint GameCommand_CardPlayed_deserialize(void * this, void * serializer) */

uint __thiscall GameCommand_CardPlayed_deserialize(void *this,void *serializer)

{
  ...
  uint uVar2;
                    ...
                    /* Deserializes CardPlayed, reading four payload fields at offsets 0x24 through
                       0x30 after the common base read sequence. */
  this_00 = serializer;
