// addr: 0x01522ff0
// name: UserDataCommand_RespondDBHonors_dtor
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void UserDataCommand_RespondDBHonors_dtor(void * this) */

void __fastcall UserDataCommand_RespondDBHonors_dtor(void *this)

{
  ...
  undefined4 local_4;
                    ...
                    /* Destroys a RespondDBHonors object by restoring its vtable and freeing four
                       string/vector-style member buffers before the base cleanup. */
  puStack_8 = &LAB_016b8c84;
