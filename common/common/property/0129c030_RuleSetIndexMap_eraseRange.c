// addr: 0x0129c030
// name: RuleSetIndexMap_eraseRange
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void RuleSetIndexMap_eraseRange(void * tree, void * outIterator, void *
...

{
  ...
  undefined1 local_8 [8];
                    ...
                    /* Erases a range from the RuleSetIndexMap red-black tree, handling the
                       whole-tree case by destroying the right chain and resetting the header. */
  unused1 = outIterator;
  ...
  if (firstOwner == pvVar1) {
    ...
    if (lastOwner == pvVar1) {
      FUN_01299c80(*(undefined4 *)(*(int *)((int)this + 4) + 4));
  ...
  while( true ) {
    ...
    StdRbTreeIterator24_advance((int *)&outIterator);
    RuleSetMap_eraseNode(this,local_8,unused1,unused2,unaff_EDI);
    unused2 = firstNode;
    unused1 = firstOwner;
  }
  *(void **)tree = unused1;
