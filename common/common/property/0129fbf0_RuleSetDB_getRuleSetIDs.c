// addr: 0x0129fbf0
// name: RuleSetDB_getRuleSetIDs
// subsystem: common/common/property
// source (binary assert): common/common/property/RuleSetDB.cpp
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool RuleSetDB_getRuleSetIDs(void * outIDs, int version) */

bool __thiscall RuleSetDB_getRuleSetIDs(void *this,void *outIDs,int version)

{
  ...
  undefined1 auStack_10 [12];
                    ...
                    /* Ensures the RuleSetDB data for the requested version is loaded, iterates the
                       rule-set map, and appends each rule-set ID key into the supplied vector. The
                       vector growth/insertion code is the only side effect besides the version
                       load. */
  iVar4 = version;
  if (version == -1) {
    FUN_012f5a60("v != -1","..\\common\\common\\property\\RuleSetDB.cpp",0x16f);
  }
  RuleSetDB_openStorageForVersion(this,iVar4);
