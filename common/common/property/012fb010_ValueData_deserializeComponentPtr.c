// addr: 0x012fb010
// name: ValueData_deserializeComponentPtr
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool ValueData_deserializeComponentPtr(void * stream, void ** outComponent) */

bool __cdecl ValueData_deserializeComponentPtr(void *stream,void **outComponent)

{
  ...
  undefined4 uStack_4;
                    ...
                    /* Deserializes an optional component pointer by reading a null flag, packed
                       component type id, constructing from ComponentFactory, and invoking its
                       deserialize method. */
