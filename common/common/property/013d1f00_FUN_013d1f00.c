...
/* Setting prototype: void CardFormula_collectEffectIds(void * this, void * outVector) */

void __thiscall CardFormula_collectEffectIds(void *this,void *outVector)

{
  ...
  undefined4 local_4;
                    ...
                    /* Initializes an output vector and appends values from the tree at this+0x50.
                        */
  puStack_8 = &LAB_0168b1f9;
  ...
  *(undefined4 *)((int)outVector + 0xc) = 0;
  ...
  while( true ) {
    ...
    if (piVar2 == (int *)*(int *)((int)this + 0x50)) {
      FUN_00d83c2d(uVar6);
    }
