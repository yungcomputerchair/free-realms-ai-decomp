...
/* Setting prototype: void StateMachineTree_eraseRange(void * tree, void * outIt, void * firstTree,
...

{
  ...
  undefined1 local_8 [8];
                    ...
                    /* Erases a range from a state-machine/action tree, clearing all nodes when the
                       range covers the full tree. */
  ...
  if (firstTree == pvVar1) {
    ...
    if (lastTree == pvVar1) {
      FUN_01353060(*(undefined4 *)(*(int *)((int)this + 4) + 4));
  ...
  while( true ) {
    ...
    FUN_0134f3a0();
    FUN_01359ca0(local_8,outIt,firstTree);
  }
  *(void **)tree = outIt;
