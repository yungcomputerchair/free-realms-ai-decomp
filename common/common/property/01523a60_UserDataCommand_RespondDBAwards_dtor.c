// addr: 0x01523a60
// name: UserDataCommand_RespondDBAwards_dtor
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void UserDataCommand_RespondDBAwards_dtor(void * this) */

void __fastcall UserDataCommand_RespondDBAwards_dtor(void *this)

{
  ...
  undefined4 local_4;
                    ...
                    /* Destroys a RespondDBAwards object by restoring its vtable and freeing four
                       owned string/vector-style buffers. */
  puStack_8 = &LAB_016b8db4;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  *(undefined ***)this = UserDataCommand_RespondDBAwards::vftable;
  local_4 = 3;
