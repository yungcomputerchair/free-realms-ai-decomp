// addr: 0x01531230
// name: EventCommand_RespondEventSessionInfo_cloneFirstIntVectorMap
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void EventCommand_RespondEventSessionInfo_cloneFirstIntVectorMap(void * this,
   void * unused, void * source_tree) */

void __thiscall
EventCommand_RespondEventSessionInfo_cloneFirstIntVectorMap
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Clears the destination tree at offset 0x10, then clones each source key and
                       its integer vector values into the destination. */
  puStack_8 = &LAB_016bb608;
  local_c = ExceptionList;
  uVar6 = DAT_01b839d8 ^ (uint)&stack0xffffffc8;
  ExceptionList = &local_c;
  local_4 = 0;
  FUN_012446b0(*(undefined4 *)(*(int *)((int)this + 0x10) + 4));
