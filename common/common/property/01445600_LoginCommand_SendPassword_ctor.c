// addr: 0x01445600
// name: LoginCommand_SendPassword_ctor
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * LoginCommand_SendPassword_ctor(void * this) */

void * __fastcall LoginCommand_SendPassword_ctor(void *this)

{
  ...
  undefined4 local_4;
                    ...
                    /* Constructs a LoginCommand_SendPassword, initializes string/map members, fills
                       primary/secondary tokens and object fields, and sets login command property
                       ids. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016996a5;
  ...
  *(undefined1 *)((int)this + 0x24) = 0;
  local_4._1_3_ = 0;
  local_4._0_1_ = 2;
  RbTree_initHeader((void *)((int)this + 0x3c));
  ...
  *(undefined1 *)((int)this + 0xf8) = 0;
  ...
  std::basic_string<char,std::char_traits<char>,std::allocator<char>_>::assign
            ((basic_string<char,std::char_traits<char>,std::allocator<char>_> *)((int)this + 100),
             pbVar1,0,0xffffffff);
  local_4._0_1_ = 10;
  if (0xf < local_10) {
  ...
  std::basic_string<char,std::char_traits<char>,std::allocator<char>_>::assign
            ((basic_string<char,std::char_traits<char>,std::allocator<char>_> *)((int)this + 0xf4),
             pbVar1,0,0xffffffff);
  local_30 = (void *)0x1;
