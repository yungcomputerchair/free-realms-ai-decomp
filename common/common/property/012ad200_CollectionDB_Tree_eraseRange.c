// addr: 0x012ad200
// name: CollectionDB_Tree_eraseRange
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void CollectionDB_Tree_eraseRange(void * tree, void * outIterator, void *
   firstOwner, void * firstNode, void * lastOwner, void * lastNode) */

void __thiscall
CollectionDB_Tree_eraseRange
...

{
  ...
  undefined1 local_8 [8];
                    ...
                    /* Erases a range from a CollectionDB red-black tree, including whole-tree
                       destruction and header reset. */
  unused1 = outIterator;
  ...
  while( true ) {
    ...
    CollectionDB_TreeIterator_next((int *)&outIterator);
    CollectionDB_StringTree_eraseNode(this,local_8,unused1,unused2,unaff_EDI);
    unused2 = firstNode;
    unused1 = firstOwner;
  }
  *(void **)tree = unused1;
