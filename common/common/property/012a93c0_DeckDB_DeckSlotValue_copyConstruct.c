...

{
  ...
  undefined4 local_4;
                    ...
                    /* Copy-constructs a DeckDB deck-slot value by initializing/copying a
                       std::string name and storing a following integer field. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0166c288;
