// addr: 0x013ed2b0
// name: DeckValidation_validateNoRareCards
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Restarted to delay deadcode elimination for space: stack */
/* Setting prototype: bool DeckValidation_validateNoRareCards(void * deck, void * errors) */

bool DeckValidation_validateNoRareCards(void *deck,void *errors)

{
  ...
  undefined4 local_4;
                    ...
                    /* Validates a deck for a no-rare rule, first applying max three copies per
                       title and then flagging rare-rarity cards. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0168ed88;
  ...
  if (iVar3 != 0) {
    ...
    std::basic_string<char,std::char_traits<char>,std::allocator<char>_>::assign
              (abStack_5c,"You may not have Rare rarity cards in your draw deck.",0x35);
    local_c._0_1_ = 4;
