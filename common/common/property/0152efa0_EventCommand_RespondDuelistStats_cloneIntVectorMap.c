// addr: 0x0152efa0
// name: EventCommand_RespondDuelistStats_cloneIntVectorMap
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void EventCommand_RespondDuelistStats_cloneIntVectorMap(void * this, void *
   unused, void * source_tree) */

void __thiscall
EventCommand_RespondDuelistStats_cloneIntVectorMap(void *this,void *unused,void *source_tree)

{
  ...
  undefined4 local_4;
                    ...
                    /* Clears a destination tree, iterates a source rb-tree whose values are integer
                       vectors, copies each vector into the destination node selected by key, then
                       destroys temporary tree state. */
  puStack_8 = &LAB_016bae58;
