// addr: 0x014dce40
// name: GameCommand_GameOverReached_deserialize
// subsystem: common/common/property
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool GameCommand_GameOverReached_deserialize(void * this, void * serializer)
    */

bool __thiscall GameCommand_GameOverReached_deserialize(void *this,void *serializer)
