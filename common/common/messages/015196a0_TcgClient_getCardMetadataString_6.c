// addr: 0x015196a0
// name: TcgClient_getCardMetadataString_6
// subsystem: common/common/messages
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


basic_string<char,std::char_traits<char>,std::allocator<char>_> *
TcgClient_getCardMetadataString_6
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Generic wrapper that lazily initializes the card metadata string tables and
                       copies the string for the supplied key. The exact category is not visible in
                       the decompiled body, only the shared table lookup pattern. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b79c9;
