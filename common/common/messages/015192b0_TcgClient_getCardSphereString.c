// addr: 0x015192b0
// name: TcgClient_getCardSphereString
// subsystem: common/common/messages
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


basic_string<char,std::char_traits<char>,std::allocator<char>_> *
TcgClient_getCardSphereString
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Looks up a key in the lazily initialized card metadata string tables and
                       returns a copy. The adjacent initializer includes sphere-like strings such as
                       Nature, Chaos, Machine, and Order; category assignment is inferred from
                       wrapper order. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b7809;
