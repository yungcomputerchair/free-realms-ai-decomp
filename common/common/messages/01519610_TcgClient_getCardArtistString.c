// addr: 0x01519610
// name: TcgClient_getCardArtistString
// subsystem: common/common/messages
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


basic_string<char,std::char_traits<char>,std::allocator<char>_> *
TcgClient_getCardArtistString
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Looks up a TCG artist-credit metadata string and returns a copy. The
                       initializer contains many artist names and collaborations such as
                       InvalidArtist, Afif / Asafat, Anna Fehr, and Raj / The. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b7989;
