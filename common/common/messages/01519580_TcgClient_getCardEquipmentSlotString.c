// addr: 0x01519580
// name: TcgClient_getCardEquipmentSlotString
// subsystem: common/common/messages
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


basic_string<char,std::char_traits<char>,std::allocator<char>_> *
TcgClient_getCardEquipmentSlotString
...

{
  ...
  undefined4 local_4;
                    ...
                    /* Looks up a TCG equipment/slot metadata string and returns a copy. The
                       initializer includes slot strings such as Hat, Chest, Hands, Shoulders,
                       Weapon, Legs, and Jewelry; caller 01452bb0 formats lists through this
                       wrapper. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b7949;
