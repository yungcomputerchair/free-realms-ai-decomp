...
GetTargetState_ctor(undefined4 *param_1,undefined4 param_2,undefined4 param_3,int param_4)

{
  ...
  undefined4 local_4;
                    ...
                    /* Constructs GetTargetState by invoking the CancellableStateMachineState
                       constructor, installing GetTargetState::vftable, setting its name string,
                       configuring cancel/default text, and copying message/version data. Evidence
                       is the GetTargetState string and vftable plus caller state transitions. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016940fa;
