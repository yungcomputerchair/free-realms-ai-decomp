// addr: 0x0138f400
// name: Card_checkModifierPredicate68
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool Card_checkModifierPredicate68(void * this, void * context, int bucketId_)
    */

bool __thiscall Card_checkModifierPredicate68(void *this,void *context,int bucketId_)

{
  ...
  undefined1 local_8 [8];
                    ...
                    /* For non-default contexts, looks up a modifier bucket and calls each modifier
                       virtual predicate at vtable+0x68 with the supplied object, failing if any
    ...
    if (iVar3 != iVar1) {
      ...
      if ((puVar7 != (undefined4 *)0x0) &&
        ...
        while( true ) {
          ...
          cVar5 = (**(code **)(*(int *)*puVar7 + 0x68))(context);
          if (cVar5 == '\0') {
            return false;
          }
          if (*(undefined4 **)(iVar3 + 0x18) <= puVar7) {
