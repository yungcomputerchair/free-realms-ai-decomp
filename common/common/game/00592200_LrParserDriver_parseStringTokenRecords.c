// addr: 0x00592200
// name: LrParserDriver_parseStringTokenRecords
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int LrParserDriver_parseStringTokenRecords(void * this, void *
   reductionCallback) */

int __thiscall LrParserDriver_parseStringTokenRecords(void *this,void *reductionCallback)
...
LAB_0059220b:
  ...
  *(undefined4 *)(*(int *)((int)this + 0x40) * 0x18 + *(int *)((int)this + 0x3c)) =
  ...
  do {
    ...
    uVar2 = *(ushort *)
             (*(int *)(*(int *)(*(int *)this + 0x4c) +
                      *(int *)(*(int *)((int)this + 0x40) * 0x18 + *(int *)((int)this + 0x3c)) * 4)
             + *piVar1 * 2);
    uVar7 = (uint)uVar2;
    if ((short)uVar2 < 0) {
      ...
      do {
        ...
        *(uint *)(*(int *)((int)this + 0x40) * 0x18 + *(int *)((int)this + 0x3c)) = uVar7 & 0x3fff;
        FUN_0054e898(piVar1,it);
        ...
        if ((*pbVar8 & 1) != 0) {
          if (*piVar1 == 0) {
            ...
            local_8 = *(void **)(*(int *)((int)this + 0x40) * 0x18 + -0x14 +
                                *(int *)((int)this + 0x3c));
          }
          ...
          FUN_0055940a(piVar1,it);
          pbVar8 = (byte *)CheckedVector_ushort_at_constB
                                     (*(undefined4 *)
                                       (*(int *)((int)this + 0x40) * 0x18 +
                                       *(int *)((int)this + 0x3c)));
          if ((*pbVar8 & 2) == 0) {
            ...
            LexerPagedRecordSet_selectPage2000
                      (it,*(int *)(*(int *)((int)this + 0x40) * 0x18 + -0x14 +
        ...
        pbVar8 = (byte *)CheckedVector_ushort_at_constB
                                   (*(undefined4 *)
                                     (*(int *)((int)this + 0x40) * 0x18 + *(int *)((int)this + 0x3c)
                                     ));
        if ((*pbVar8 & 1) == 0) {
          *(undefined4 *)(*(int *)((int)this + 0x40) * 0x18 + 4 + *(int *)((int)this + 0x3c)) =
               0xffffffff;
        }
        else {
          iVar9 = SegmentedIterator2000_getAbsoluteIndex_A(it);
          *(int *)(*(int *)((int)this + 0x40) * 0x18 + 4 + *(int *)((int)this + 0x3c)) = iVar9;
          LexerPagedRecordSet_contains
                    (it,*(int *)(*(int *)((int)this + 0x40) * 0x18 + 4 + *(int *)((int)this + 0x3c))
                    );
        }
        pvVar6 = (void *)(**(code **)*it)();
        ...
        uVar2 = *(ushort *)
                 (*(int *)(*(int *)(*(int *)this + 0x4c) +
                          *(int *)(*(int *)((int)this + 0x40) * 0x18 + *(int *)((int)this + 0x3c)) *
                          4) + *piVar1 * 2);
        uVar7 = (uint)uVar2;
      } while ((short)uVar2 < 0);
    }
    if ((uVar7 & 0x4000) == 0) {
      ...
      if (pvVar6 != (void *)0x0) {
        do {
          iVar9 = *(int *)((*(int *)((int)this + 0x40) - (int)local_8) * 0x18 + 4 +
                          *(int *)((int)this + 0x3c));
          if (iVar9 != -1) {
      ...
      *(int *)((int)this + 0x40) = *(int *)((int)this + 0x40) + (1 - (int)pvVar6);
      ...
      iVar9 = (int)*(short *)(*(int *)(*(int *)(*(int *)this + 0x58) +
                                      *(int *)(*(int *)((int)this + 0x40) * 0x18 + -0x18 +
...
LAB_005926f9:
    ...
    do {
      ...
      if ((uVar2 & 0xc000) != 0) {
        while (local_c = uVar7, (uVar2 & 0x4000) != 0) {
          ...
          iVar4 = *(int *)(local_c * 0x18 + -0x18 + *(int *)((int)this + 0x3c));
    ...
    if (local_c == 0) goto LAB_005926f9;
    puVar10 = (uint *)((int)this + 0x50);
    while (*(int *)(*(int *)((int)this + 100) + *puVar10 * 4) == -1) {
      if ((*puVar10 == 0) || (*puVar10 == 1)) goto LAB_005926f9;
      pvVar6 = (void *)(*(code *)**(undefined4 **)((int)this + 8))();
    ...
    if ((*(ushort *)
      ...
      StdVector24_truncateAndRelease(this,*(int *)(*(int *)((int)this + 100) + *puVar10 * 4));
    }
