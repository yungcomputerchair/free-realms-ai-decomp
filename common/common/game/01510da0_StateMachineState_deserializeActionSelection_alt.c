// addr: 0x01510da0
// name: StateMachineState_deserializeActionSelection_alt
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined1 __thiscall StateMachineState_deserializeActionSelection_alt(int *param_1,void *param_2)

{
  ...
  undefined4 uStack_c;
                    ...
                    /* Alternate duplicate-shaped deserializer for an action-selection state,
                       reading integer fields, triple-int lists, play-area objects, and card actions
                       by id. */
  uStack_c = 0xffffffff;
  puStack_10 = &LAB_016b6970;
...
LAB_01511214:
                    ...
                    if (bVar1) {
                      if ((iStack_90 != 0) && (unaff_EBX != 0)) {
                        ...
                        if (pvVar5 == (void *)0x0) goto LAB_01510f9f;
                      }
...
LAB_01511381:
                                      ...
                                      if (pvVar5 != (void *)0x0) goto LAB_01511381;
                                    }
                                  }
                                }
                              }
