// addr: 0x005f719c
// name: LexerPagedSetIterator_seek
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: uint LexerPagedSetIterator_seek(void * this, uint index) */

uint __thiscall LexerPagedSetIterator_seek(void *this,uint index)

{
  ...
  uint3 extraout_var;
                    ...
                    /* Seeks a lexer paged-set iterator to a ushort-indexed record and updates
                       current id and absolute index. */
