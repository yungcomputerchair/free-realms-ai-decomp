...
void __thiscall FUN_01445eb0(int param_1,undefined4 param_2)

{
  ...
  FUN_01241650("Send Session ID Login Command\n",0x1e);
  ...
  _sprintf(local_3ec,"SessionID: %s\n",iVar3);
  pcVar2 = local_3ec;
  do {
    cVar1 = *pcVar2;
    pcVar2 = pcVar2 + 1;
  ...
  FUN_01241650(local_3ec,(int)pcVar2 - (int)(local_3ec + 1));
  _sprintf(local_3ec,"Is Parent Session ID: %d\n",(uint)*(byte *)(param_1 + 100));
  pcVar2 = local_3ec;
  do {
    cVar1 = *pcVar2;
    pcVar2 = pcVar2 + 1;
