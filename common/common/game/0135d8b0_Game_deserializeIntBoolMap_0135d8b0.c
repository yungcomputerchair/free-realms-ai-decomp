// addr: 0x0135d8b0
// name: Game_deserializeIntBoolMap_0135d8b0
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: uint Game_deserializeIntBoolMap_0135d8b0(void * streamOrContainer) */

uint __fastcall Game_deserializeIntBoolMap_0135d8b0(void *streamOrContainer)
