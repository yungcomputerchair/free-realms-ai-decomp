...
void __thiscall SynchronizationCommand_RemoveNonTradable_dump(void *param_1,undefined4 param_2)

{
  ...
  uint local_4;
                    ...
                    /* Writes a textual dump of a RemoveNonTradable synchronization command,
                       including account ID, flags/mask, and each instance tuple. The command name
                       string is embedded in the function. */
  local_4 = DAT_01b839d8 ^ (uint)&local_3f4;
  local_3f0 = param_2;
  local_3f4 = param_1;
  FUN_01241650("SynchronizationCommand_RemoveNonTradable\n",0x29);
