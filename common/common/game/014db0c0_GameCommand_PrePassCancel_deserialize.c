// addr: 0x014db0c0
// name: GameCommand_PrePassCancel_deserialize
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool GameCommand_PrePassCancel_deserialize(void * this, void * stream) */

bool __thiscall GameCommand_PrePassCancel_deserialize(void *this,void *stream)
