// addr: 0x0144d8d0
// name: Game_showDeckAvailabilityMessages
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* Setting prototype: void Game_showDeckAvailabilityMessages(void) */

void Game_showDeckAvailabilityMessages(void)

{
  ...
  undefined4 local_4;
                    ...
                    /* Checks the current player's deck/vector count and sends UI/message ids 0x3729
                       or 0x28bc plus 0x28bd through the active game/session object. Evidence:
                       Game_getMyPlayerID, deck lookup helper, and message dispatch calls. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0169afd8;
