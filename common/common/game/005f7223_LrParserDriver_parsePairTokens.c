// addr: 0x005f7223
// name: LrParserDriver_parsePairTokens
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: int LrParserDriver_parsePairTokens(void * this, void * reductionCallback) */

int __thiscall LrParserDriver_parsePairTokens(void *this,void *reductionCallback)
...
LAB_005f722e:
  ...
  *(undefined4 *)(*(int *)((int)this + 0x40) * 0x10 + *(int *)((int)this + 0x3c)) =
  ...
  do {
    ...
    if ((uVar6 & 0x4000) == 0) {
      ...
      *(uint *)((int)this + 0x58) = uVar11;
      ...
      if ((uVar6 & 0x40000000) == 0) {
        ...
        if ((int)uVar15 == 0) goto LAB_005f7716;
      }
      if (-1 < (int)uVar6) goto LAB_005f722e;
    ...
    if ((int)uVar11 < 0) {
LAB_005f7716:
      LexerTraversalStack_resize(this,uVar11);
      return -2;
    }
    ...
    local_10 = uVar11;
    if (local_c == 0) goto LAB_005f7716;
    puVar10 = (uint *)((int)this + 0x50);
    uVar6 = *puVar10;
    while (*(int *)(*(int *)((int)this + 0x5c) + uVar6 * 4) == -1) {
      if ((*puVar10 == 0) || (*puVar10 == 1)) goto LAB_005f7716;
