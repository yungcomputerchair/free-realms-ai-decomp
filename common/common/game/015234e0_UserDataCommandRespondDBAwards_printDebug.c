// addr: 0x015234e0
// name: UserDataCommandRespondDBAwards_printDebug
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */
/* Setting prototype: void UserDataCommandRespondDBAwards_printDebug(void * this, void * out) */

void __thiscall UserDataCommandRespondDBAwards_printDebug(void *this,void *out)

{
  ...
  uint local_4;
                    ...
                    /* Prints detailed DB award response rows after checking award id, title, icon,
                       and description vector sizes; emits an uneven-vector diagnostic if sizes
                       differ. */
    ...
    if (iVar4 == iVar2) {
      ...
      if (iVar4 == iVar2) {
        ...
        while( true ) {
          ...
          _sprintf(local_3ec,"mAwardIDs: %d\n",
