...
void __thiscall SynchronizationCommand_UnlockTournament_dump(void *param_1,undefined4 param_2)

{
  ...
  uint local_4;
                    ...
                    /* Writes a textual dump of an UnlockTournament synchronization command,
  ...
  local_3f0 = param_2;
  local_3f4 = param_1;
  FUN_01241650("SynchronizationCommand_UnlockTournament\n",0x28);
