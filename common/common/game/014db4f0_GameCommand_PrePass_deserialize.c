// addr: 0x014db4f0
// name: GameCommand_PrePass_deserialize
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool GameCommand_PrePass_deserialize(void * this, void * stream) */

bool __thiscall GameCommand_PrePass_deserialize(void *this,void *stream)
