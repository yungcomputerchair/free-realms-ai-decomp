// addr: 0x005722ce
// name: PagedSparseRecordIterator2000_seekA
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: uint PagedSparseRecordIterator2000_seekA(void * this, uint index) */

uint __thiscall PagedSparseRecordIterator2000_seekA(void *this,uint index)

{
  ...
  uint3 extraout_var;
                    ...
                    /* Seeks a paged sparse-record iterator to a ushort table entry, updates current
                       record id and absolute index using the A iterator path. */
