// addr: 0x01522a70
// name: UserDataCommandRespondDBHonors_printDebug
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */
/* Setting prototype: void UserDataCommandRespondDBHonors_printDebug(void * this, void * out) */

void __thiscall UserDataCommandRespondDBHonors_printDebug(void *this,void *out)

{
  ...
  uint local_4;
                    ...
                    /* Prints DB honor response rows after checking honor id, title, icon, and
                       requirements vector sizes, with an uneven-vector diagnostic on mismatch. */
  local_4 = DAT_01b839d8 ^ (uint)local_3ec;
  FUN_01241650("UserData Command Respond DB Honors\n",0x23);
  FUN_0140c290(out);
    ...
    if (iVar4 == iVar2) {
      ...
      if (iVar4 == iVar2) {
        ...
        while( true ) {
          ...
          _sprintf(local_3ec,"mHonorIDs: %d\n",
          ...
          _sprintf(local_3ec,"mRequirements: %s\n",iVar2);
          pcVar3 = local_3ec;
          do {
            cVar1 = *pcVar3;
            pcVar3 = pcVar3 + 1;
  ...
  _sprintf(local_3ec,"mRequirements: %d\n",iVar4);
  pcVar3 = local_3ec;
  do {
    cVar1 = *pcVar3;
    pcVar3 = pcVar3 + 1;
