// addr: 0x013d8f60
// name: LobbyCommand_OfferAdjournedGame_dump
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */
/* Setting prototype: void LobbyCommand_OfferAdjournedGame_dump(void * this, void * out) */

void __thiscall LobbyCommand_OfferAdjournedGame_dump(void *this,void *out)

{
  ...
  uint local_4;
                    ...
                    /* Writes a text dump for Offer Adjourned Game lobby commands, after the
                       LobbyCommand base dump, showing match, game, and lobby IDs. */
  local_4 = DAT_01b839d8 ^ (uint)local_3f0;
  FUN_01241650("Offer Adjourned Game Lobby Command\n",0x23);
