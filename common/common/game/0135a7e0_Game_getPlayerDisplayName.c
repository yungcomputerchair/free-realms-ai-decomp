...

{
  ...
  uint local_4;
                    ...
                    /* Builds a display-name string for a player/play-area element, consulting the
                       lobby account singleton/account map and falling back to formatted element
                       data. Evidence: PlayArea_findPlayerElementById and
                       LobbyServiceAccountMap_findValue. */
  puStack_8 = &LAB_0167e11d;
