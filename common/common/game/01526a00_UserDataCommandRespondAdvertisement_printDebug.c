// addr: 0x01526a00
// name: UserDataCommandRespondAdvertisement_printDebug
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */
/* Setting prototype: void UserDataCommandRespondAdvertisement_printDebug(void * this, void * out)
    */

void __thiscall UserDataCommandRespondAdvertisement_printDebug(void *this,void *out)

{
  ...
  uint local_4;
                    ...
                    /* Prints advertisement response rows containing callbacks, params, values, and
                       images after validating vector sizes; prints size diagnostics on mismatch. */
  local_4 = DAT_01b839d8 ^ (uint)local_3ec;
  FUN_01241650("UserData Command Respond Advertisement\n",0x27);
  FUN_0140c290(out);
