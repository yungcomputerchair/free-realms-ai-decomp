// addr: 0x006b090e
// name: PagedSparseRecordIterator2000_seekRecordB
// subsystem: common/common/game
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: uint PagedSparseRecordIterator2000_seekRecordB(void * this, uint index) */

uint __thiscall PagedSparseRecordIterator2000_seekRecordB(void *this,uint index)

{
  ...
  uint3 extraout_var;
                    ...
                    /* Seeks to a ushort-indexed sparse record using the alternate B absolute-index
                       path and validates it against the alternate record set. */
        ...
        **(undefined4 **)((int)this + 0x3c) = in_EAX;
        ...
        if ((*pbVar2 & 1) == 0) {
          ...
          *(undefined4 *)(iVar3 + 4) = 0xffffffff;
          ...
          iVar3 = SegmentedIterator2000_getAbsoluteIndex_B((void *)((int)this + 8));
