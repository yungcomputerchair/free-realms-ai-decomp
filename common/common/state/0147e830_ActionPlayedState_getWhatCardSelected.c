// addr: 0x0147e830
// name: ActionPlayedState_getWhatCardSelected
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined4 __fastcall ActionPlayedState_getWhatCardSelected(int param_1)

{
  ...
  undefined4 local_4;
                    ...
                    /* Implements the operation identified by referenced string
                       'ActionPlayedState::getWhatCardSelected'. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016a05ab;
  local_c = ExceptionList;
  uVar1 = DAT_01b839d8 ^ (uint)&stack0xffffffe8;
  ExceptionList = &local_c;
  fmt = "ActionPlayedState::getWhatCardSelected";
  pvVar2 = (void *)StateMachineState_getGame();
  Game_logGeneral(pvVar2,fmt,uVar1);
  if ((*(int *)(param_1 + 0x100) == 0) && (*(char *)(param_1 + 0x161) != '\0')) {
    *(undefined1 *)(param_1 + 0x10c) = 1;
    *(undefined4 *)(param_1 + 0x114) = 0xb;
