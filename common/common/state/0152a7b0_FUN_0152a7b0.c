...
undefined4 __fastcall FUN_0152a7b0(int param_1)

{
  ...
  DisplayActionBuilder_addStringArg(this,(void *)(param_1 + 0x4c));
  DisplayActionBuilder_addStringArg(this,(void *)(param_1 + 0x68));
  DisplayActionBuilder_addBoolArg(this,*(bool *)(param_1 + 0x48));
