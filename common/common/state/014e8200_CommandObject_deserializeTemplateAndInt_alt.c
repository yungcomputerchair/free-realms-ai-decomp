// addr: 0x014e8200
// name: CommandObject_deserializeTemplateAndInt_alt
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool CommandObject_deserializeTemplateAndInt_alt(void * this, void * reader)
    */

bool __thiscall CommandObject_deserializeTemplateAndInt_alt(void *this,void *reader)
