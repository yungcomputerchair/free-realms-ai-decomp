...
int __thiscall FUN_014d3e20(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes a single integer field at this+8 after FUN_014d6880. No
                       class-identifying strings or named callers are present. */
