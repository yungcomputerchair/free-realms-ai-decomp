// addr: 0x0147b430
// name: ChainedActionState_checkReturnValue
// subsystem: common/common/rules
// source (binary assert): common/common/state/ChainedActionState.cpp
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Removing unreachable block (ram,0x0147bc45) */

undefined4 __fastcall ChainedActionState_checkReturnValue(int param_1)

{
  ...
  undefined4 uStack_4;
                    ...
                    /* Processes ChainedActionState ReturnValueMap updates for
                       discard/draw/reveal/target/custom-number/dynamic-card returns and end/cancel
                       conditions. */
  uStack_4 = 0xffffffff;
  puStack_8 = &LAB_016a01d8;
  ...
  if ((cVar2 != '\0') && (*(char *)(param_1 + 0x128) == '\0')) {
    pcVar12 = "ChainedActionState::checkReturnValue environment has got target, we don\'t. setting."
    ;
  ...
  if ((((cVar2 == '\0') && (cVar2 = ReturnValueMap_hasIntegerKey(2), cVar2 == '\0')) &&
     ...
     (cVar2 = ReturnValueMap_hasIntegerKey(0x37), cVar2 == '\0')) goto LAB_0147b738;
  cVar2 = ReturnValueMap_hasIntegerKey(1);
  if (cVar2 == '\0') {
...
LAB_0147b533:
  ...
  pcVar12 = "ChainedActionState::checkReturnValue - Found target Return %d";
  pvVar4 = (void *)StateMachineState_getGame();
...
LAB_0147b738:
  ...
  if (cVar2 != '\0') {
    ...
    if (*(int *)((int)pvVar4 + 4) != 6) {
      FUN_012f5a60("value->isIntegerListValue()","..\\common\\common\\state\\ChainedActionState.cpp"
                   ,0x94);
    }
    iVar6 = FUN_0123c3a0();
    if (*(int *)(iVar6 + 4) == 0) {
    ...
    pcVar12 = "ChainedActionState::checkReturnValue - Found customCardList Return %d";
    pvVar4 = (void *)StateMachineState_getGame();
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasIntegerKey(kDynamicCardReturn)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0xaa);
    }
    uVar7 = ReturnValueMap_getInteger(0x23);
    pcVar12 = "ChainedActionState::checkReturnValue - Found dynamicCard Return %d";
    uVar13 = uVar7;
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,uVar13);
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasIntegerKey(kCustomNumberReturn)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0xb2);
    }
    uVar13 = ReturnValueMap_getInteger(0x2e);
    EvaluationEnvironment_setCustomNumberReturn(uVar13);
    pcVar12 = "ChainedActionState::checkReturnValue - Found customnumber Return %d";
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,uVar13);
  }
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasIntegerKey(kCustomNumber2Return)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0xb9);
    }
    uVar13 = ReturnValueMap_getInteger(0x2f);
    EvaluationEnvironment_setCustomNumber2Return(uVar13);
    pcVar12 = "ChainedActionState::checkReturnValue - Found customnumber2 Return %d";
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,uVar13);
  }
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasIntegerKey(kMultiActionNumReturn)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0xc0);
    }
    uVar7 = ReturnValueMap_getInteger(10);
    pcVar12 = "ChainedActionState::checkReturnValue - Found MultiActionNum Return %d";
    uVar13 = uVar7;
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,uVar13);
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasBooleanKey(kTargetGottenReturn)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0xd0);
    }
    pcVar12 = "ChainedActionState::checkReturnValue - Found TargetGotten return";
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,item);
    FUN_01385f30(auStack_1c);
    uStack_4 = 3;
  ...
  if (cVar2 != '\0') {
    pcVar12 = "ChainedActionState::checkReturnValue - Found RevealedCards Return";
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,item);
    pvVar4 = ReturnValueMap_findValueData(pvVar3,key__00);
    if (((*(int *)((int)pvVar4 + 4) == 6) ||
        (FUN_012f5a60("value->isIntegerListValue()",
                      "..\\common\\common\\state\\ChainedActionState.cpp",0xdc),
        *(int *)((int)pvVar4 + 4) == 6)) ||
    ...
    if (cVar2 != '\0') {
      ...
      if (cVar2 == '\0') {
        FUN_012f5a60("rvm->hasIntegerKey(kRevealIDReturn)",
                     "..\\common\\common\\state\\ChainedActionState.cpp",0xec);
      }
      puVar8 = (uint *)ReturnValueMap_getInteger(0x22);
      pcVar12 = "ChainedActionState::checkReturnValue - Found RevealID: %d";
      puStack_34 = puVar8;
      pvVar4 = (void *)StateMachineState_getGame();
  ...
  if (cVar2 != '\0') {
    pcVar12 = "ChainedActionState::checkReturnValue - Found Random Return";
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,item);
    pvVar4 = ReturnValueMap_findValueData(pvVar3,key__01);
    if (((*(int *)((int)pvVar4 + 4) == 0xd) ||
        (FUN_012f5a60("value->isIntIntMapValue()",
                      "..\\common\\common\\state\\ChainedActionState.cpp",0xf7),
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasIntegerKey(kCardsDrawnReturn)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0x109);
    }
    iVar9 = ReturnValueMap_getInteger(0x34);
    pcVar12 = "ChainedActionState::checkReturnValue - Cards Drawn Return %d";
    iVar6 = iVar9;
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,iVar6);
  ...
  if (cVar2 != '\0') {
    ...
    if (cVar2 == '\0') {
      FUN_012f5a60("rvm->hasIntegerKey(kDiscardReturn)",
                   "..\\common\\common\\state\\ChainedActionState.cpp",0x111);
    }
    iVar9 = ReturnValueMap_getInteger(0x30);
    pcVar12 = "ChainedActionState::checkReturnValue - Cards Discarded Return %d";
    iVar6 = iVar9;
    pvVar4 = (void *)StateMachineState_getGame();
    Game_logGeneral(pvVar4,pcVar12,iVar6);
  ...
  if (cVar2 != '\0') {
    ...
    FUN_013f8200(uVar13);
    pcVar12 = "ChainedAction::checkReturnValue found End MultiAction, endingState.";
    *(undefined4 *)(param_1 + 0xf8) = 3;
    pvVar3 = (void *)StateMachineState_getGame();
