// addr: 0x01464e30
// name: ProcessEventEmissionState_copy_ctor
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * ProcessEventEmissionState_copy_ctor(void * this, void * other) */

void * __thiscall ProcessEventEmissionState_copy_ctor(void *this,void *other)

{
  ...
  undefined4 local_4;
                    ...
                    /* Copy-constructs a ProcessEventEmissionState, installing its vtable, name, and
                       event-emission fields. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0169db94;
