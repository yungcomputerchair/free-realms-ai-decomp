...
undefined4 __thiscall Card_attachTo(int *param_1,undefined4 param_2)

{
  ...
  Game_logGeneral((void *)param_1[0xc],"Card::attachTo card: %d, dest: %d",uVar3);
  if (iVar1 == 0) {
    ...
    piVar5 = (int *)FUN_00d8d382(uVar3,0,&PlayElement::RTTI_Type_Descriptor,
                                 &Card::RTTI_Type_Descriptor,0);
    if (piVar5 != (int *)0x0) {
      Game_logGeneral((void *)param_1[0xc],"DOING ATTACHTO",this);
      (**(code **)(*piVar5 + 0x184))(param_1,0);
