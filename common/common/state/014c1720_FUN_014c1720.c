...
int __thiscall FUN_014c1720(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes a single integer field at this+8 after FUN_013b2910 and virtual
                       begin hook. No class-identifying evidence is present. */
