// addr: 0x01465f10
// name: StateMachineState_sendButtonPressedCommand
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool StateMachineState_sendButtonPressedCommand(int button_) */

bool StateMachineState_sendButtonPressedCommand(int button_)
