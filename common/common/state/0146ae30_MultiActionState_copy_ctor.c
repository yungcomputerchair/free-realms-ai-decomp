// addr: 0x0146ae30
// name: MultiActionState_copy_ctor
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * MultiActionState_copy_ctor(void * this, void * other) */

void * __thiscall MultiActionState_copy_ctor(void *this,void *other)

{
  ...
  undefined4 local_4;
                    ...
                    /* Copy-constructs a MultiActionState, initializing maps/action lists and
                       assigning its vtable and state name. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0169e6a0;
