// addr: 0x0141c3e0
// name: GetTargetState_copy_ctor
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * GetTargetState_copy_ctor(void * this, void * other) */

void * __thiscall GetTargetState_copy_ctor(void *this,void *other)

{
  ...
  undefined4 local_4;
                    ...
                    /* Copy-constructs GetTargetState, initializing vtable/name, cancel/default
                       strings, target fields, and flags. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_01693d92;
  ...
  *(undefined1 *)((int)this + 0x121) = in_stack_00000008;
