...
FUN_01457090(int param_1,undefined4 *param_2,int param_3,int param_4,int *param_5)

{
  ...
  iVar2 = param_3;
  if (*(int *)(param_1 + 8) == 0) {
    FUN_01456a50(param_2,1,*(undefined4 *)(param_1 + 4),param_5);
    return param_2;
  }
  iVar1 = **(int **)(param_1 + 4);
  ...
  if (param_4 == iVar1) {
    ...
    if (*param_5 < *(int *)(param_4 + 0xc)) {
      FUN_01456a50(param_2,1,param_4,param_5);
      return param_2;
    }
  }
  else {
    ...
    if (iVar5 == iVar1) {
      ...
      if (*(int *)(iVar2 + 0xc) < *param_5) {
        FUN_01456a50(param_2,0,iVar2,param_5);
        return param_2;
      }
    }
    else {
      ...
      if (iVar1 < iVar3) {
        ...
        if (*(int *)(param_4 + 0xc) < iVar4) {
          if (*(char *)(*(int *)(param_4 + 8) + 0x15) != '\0') {
            FUN_01456a50(param_2,0,param_4,piVar8);
            return param_2;
          }
          FUN_01456a50(param_2,1,iVar5,piVar8);
          return param_2;
        }
      ...
      if (bVar9 != iVar4 < 0) {
        ...
        param_4 = iVar5;
        local_c = param_1;
        STLMapIterator_next(&param_3);
        cVar6 = FUN_014238a0(&local_c);
        if ((cVar6 != '\0') || (*piVar8 < *(int *)(param_4 + 0xc))) {
          if (*(char *)(*(int *)(iVar5 + 8) + 0x15) != '\0') {
            FUN_01456a50(param_2,0,iVar5,piVar8);
            return param_2;
          }
          FUN_01456a50(param_2,1,param_4,piVar8);
          return param_2;
        }
      }
    }
  }
  puVar7 = (undefined4 *)FUN_01456f00(&local_c,piVar8);
  *param_2 = *puVar7;
  param_2[1] = puVar7[1];
  return param_2;
}
