...
int __thiscall FUN_014b93b0(int *param_1,void *param_2)

{
  ...
  int local_4;
                    ...
                    /* Deserializes through FUN_01441e20, then reads a boolean-like integer field at
                       this+4 and a second integer at this+8. No class name evidence was present. */
