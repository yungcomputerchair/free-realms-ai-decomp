...
/* Setting prototype: void * CommandObject_DummyEvent_ctor(void * this) */

void * __fastcall CommandObject_DummyEvent_ctor(void *this)

{
  ...
  undefined4 local_4;
                    ...
                    /* Constructs CommandObject_DummyEvent, installs its vftable, initializes
                       fields, and assigns the name string "CommandObject_DummyEvent". Evidence is
                       the vftable and matching referenced string. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b5868;
