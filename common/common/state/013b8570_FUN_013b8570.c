...
void __thiscall
FUN_013b8570(int param_1,int *param_2,int param_3,int param_4,int param_5,int param_6)

{
  ...
  if (param_4 == iVar1) {
    ...
    if (param_6 == iVar1) {
      FUN_013b5860(*(undefined4 *)(*(int *)(param_1 + 4) + 4));
  ...
  while( true ) {
    ...
    FUN_013b4f30();
    FUN_013b5e90(local_8,param_3,param_4);
  }
  *param_2 = param_3;
  param_2[1] = param_4;
  return;
