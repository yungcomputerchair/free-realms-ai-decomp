...
int __thiscall FUN_014bbf60(int *param_1,int *param_2)

{
  ...
  int *local_4;
                    ...
                    /* Deserializes an integer, two integer vectors, and a final integer after
                       FUN_013b2910. Owning class is unknown. */
  local_4 = param_1;
