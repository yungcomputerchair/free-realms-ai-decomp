...
void __thiscall FUN_014d3480(int param_1,char *param_2)

{
  ...
  undefined4 local_4;
                    ...
                    /* Lazily allocates a small string-holder object at this+0x18 and copies the
                       supplied C string into its contained std::string. Owner identity is unknown.
                        */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016ac8c3;
