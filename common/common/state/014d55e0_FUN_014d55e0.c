...
undefined4 __fastcall FUN_014d55e0(int param_1)

{
  ...
  DisplayActionBuilder_addStringArg(this,(void *)(param_1 + 0x18));
  ...
  DisplayActionBuilder_addStringArg(this,(void *)(param_1 + 0x50));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x10));
  DisplayActionBuilder_addBoolArg(this,*(bool *)(param_1 + 0x6c));
