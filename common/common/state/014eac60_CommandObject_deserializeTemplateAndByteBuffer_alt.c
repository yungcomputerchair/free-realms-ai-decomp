// addr: 0x014eac60
// name: CommandObject_deserializeTemplateAndByteBuffer_alt
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool CommandObject_deserializeTemplateAndByteBuffer_alt(void * this, void *
   reader) */

bool __thiscall CommandObject_deserializeTemplateAndByteBuffer_alt(void *this,void *reader)
