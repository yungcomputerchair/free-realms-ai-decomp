...
void __thiscall FUN_014d3390(int param_1,char *param_2)

{
  ...
  undefined4 local_4;
                    ...
                    /* Lazily allocates a small string-holder object at this+0x14 and assigns the
                       supplied C string into its string member. The owner class/field name is not
                       identified. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016ac893;
