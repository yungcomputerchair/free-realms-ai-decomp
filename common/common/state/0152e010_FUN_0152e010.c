...
undefined4 __fastcall FUN_0152e010(int param_1)

{
  ...
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x24));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x28));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x2c));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x30));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x34));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x38));
  DisplayActionBuilder_addIntArg(this,*(int *)(param_1 + 0x3c));
