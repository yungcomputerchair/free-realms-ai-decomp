...
int __thiscall FUN_014d4010(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes an integer and a string after FUN_014d6880, then runs the
                       virtual post-read hook. Class identity is unknown. */
