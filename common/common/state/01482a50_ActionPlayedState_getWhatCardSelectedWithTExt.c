// addr: 0x01482a50
// name: ActionPlayedState_getWhatCardSelectedWithTExt
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


int __thiscall ActionPlayedState_getWhatCardSelectedWithTExt(int *param_1,void *param_2)

{
  ...
  if ((param_1[0x40] == 0) && (*(char *)((int)param_1 + 0x161) != '\0')) {
    *(undefined1 *)(param_1 + 0x43) = 1;
    ...
    param_1[0x4b] = *(int *)((int)param_2 + 4);
    param_1[0x4c] = *(int *)((int)param_2 + 8);
