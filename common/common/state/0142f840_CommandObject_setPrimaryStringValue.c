// addr: 0x0142f840
// name: CommandObject_setPrimaryStringValue
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


void __thiscall CommandObject_setPrimaryStringValue(int param_1,char *param_2)

{
  ...
  undefined4 local_4;
                    ...
                    /* Ensures a ValueData/string slot at offset 0xc exists, then stores the
                       supplied C string into it as a type-3 string value. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016961c3;
