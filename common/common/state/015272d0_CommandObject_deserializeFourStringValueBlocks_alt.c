// addr: 0x015272d0
// name: CommandObject_deserializeFourStringValueBlocks_alt
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool CommandObject_deserializeFourStringValueBlocks_alt(void * this, void *
   reader) */

bool __thiscall CommandObject_deserializeFourStringValueBlocks_alt(void *this,void *reader)
