...
int __thiscall FUN_014d2ae0(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes one integer field at this+8 after FUN_014d6880 and virtual begin
                       hook. No class-identifying evidence is available. */
