// addr: 0x015169f0
// name: StateMachineState_filterResponsesForCurrentPlayer_alt
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void StateMachineState_filterResponsesForCurrentPlayer_alt(void * this) */

void __fastcall StateMachineState_filterResponsesForCurrentPlayer_alt(void *this)
