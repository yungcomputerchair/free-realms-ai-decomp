// addr: 0x0147ab50
// name: ChainedActionState_sendCloseReveal
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined4 __thiscall ChainedActionState_sendCloseReveal(int param_1,char param_2)

{
  ...
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016a003b;
  local_c = ExceptionList;
  uVar2 = DAT_01b839d8 ^ (uint)&stack0xffffffdc;
  ExceptionList = &local_c;
  pcVar7 = "ChainedActionState::sendCloseReveal";
