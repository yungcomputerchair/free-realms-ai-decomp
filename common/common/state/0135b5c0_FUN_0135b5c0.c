...
FUN_0135b5c0(int param_1,undefined4 *param_2,int param_3,int param_4,int *param_5)

{
  ...
  if (*(int *)(param_1 + 8) == 0) {
    FUN_01359230(param_2,1,*(undefined4 *)(param_1 + 4),param_5);
    return param_2;
  }
  iVar1 = **(int **)(param_1 + 4);
  ...
  if (param_4 == iVar1) {
    if (*param_5 < *(int *)(param_4 + 0xc)) {
      FUN_01359230(param_2,1,param_4,param_5);
      return param_2;
    }
  }
  else {
    ...
    if (param_4 == iVar1) {
      ...
      if (*(int *)(iVar1 + 0xc) < *param_5) {
        FUN_01359230(param_2,0,iVar1,param_5);
        return param_2;
      }
    }
    else {
      ...
      if (iVar1 < iVar2) {
        ...
        if (*(int *)(param_4 + 0xc) < iVar3) {
          if (*(char *)(*(int *)(param_4 + 8) + 0x19) != '\0') {
            FUN_01359230(param_2,0,param_4,param_5);
            return param_2;
          }
          FUN_01359230(param_2,1,param_4,param_5);
          return param_2;
  ...
  puVar5 = (undefined4 *)FUN_0135b500(&local_c,param_5);
  *param_2 = *puVar5;
  param_2[1] = puVar5[1];
  return param_2;
}
