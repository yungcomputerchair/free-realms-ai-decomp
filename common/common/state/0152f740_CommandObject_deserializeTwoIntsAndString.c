// addr: 0x0152f740
// name: CommandObject_deserializeTwoIntsAndString
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool CommandObject_deserializeTwoIntsAndString(void * this, void * reader) */

bool __thiscall CommandObject_deserializeTwoIntsAndString(void *this,void *reader)
