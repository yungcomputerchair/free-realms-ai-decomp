...
int __thiscall FUN_014ce300(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes a single string member at this+8 after FUN_013b2910. No
                       class-identifying strings or callers are present. */
