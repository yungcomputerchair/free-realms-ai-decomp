...
int __thiscall FUN_014c35d0(int *param_1,void *param_2)

{
  ...
  int *local_4;
                    ...
                    /* Deserializes an integer at this+8 and a boolean-like integer stored as a byte
                       at this+0xc after FUN_013b2910. No safe class name is present. */
  local_4 = param_1;
