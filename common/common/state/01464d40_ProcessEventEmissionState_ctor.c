// addr: 0x01464d40
// name: ProcessEventEmissionState_ctor
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * ProcessEventEmissionState_ctor(void * this) */

void * __fastcall ProcessEventEmissionState_ctor(void *this)

{
  ...
  undefined4 local_4;
                    ...
                    /* Constructs a ProcessEventEmissionState, initializing its StateMachineState
                       base, vtable, name, and event-emission fields. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_0169db54;
  local_c = ExceptionList;
  ExceptionList = &local_c;
  CancellableStateMachineState_ctor(DAT_01b839d8 ^ (uint)&stack0xffffffe8);
  *(undefined ***)this = ProcessEventEmissionState::vftable;
