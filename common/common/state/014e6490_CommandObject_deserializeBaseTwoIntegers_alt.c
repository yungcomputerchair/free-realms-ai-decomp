// addr: 0x014e6490
// name: CommandObject_deserializeBaseTwoIntegers_alt
// subsystem: common/common/state
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool CommandObject_deserializeBaseTwoIntegers_alt(void * this, void * reader)
    */

bool __thiscall CommandObject_deserializeBaseTwoIntegers_alt(void *this,void *reader)
