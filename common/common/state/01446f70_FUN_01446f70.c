...
int __thiscall FUN_01446f70(int *param_1,void *param_2)

{
  ...
  if (extraout_AL != '\0') {
    ...
    if (bVar1) {
      bVar1 = Deserializer_readString(param_2,param_1 + 2);
      uVar3 = extraout_var_01;
      if (bVar1) {
        bVar1 = Deserializer_readInteger(param_2,param_1 + 10);
        uVar3 = extraout_var_02;
        if (bVar1) {
          FUN_01302e20(param_2,param_1 + 9);
          uVar3 = extraout_var_03;
          if (extraout_AL_00 != '\0') {
            FUN_01244910();
            GameObjectIdVector_deserialize(param_1 + 0xb);
