...
undefined4 __fastcall FUN_014d11e0(int param_1)

{
  ...
  DisplayActionBuilder_addStringArg(this,(void *)(param_1 + 0x30));
  DisplayActionBuilder_addBoolArg(this,*(bool *)(param_1 + 0x4c));
