...
int __thiscall FUN_014bb310(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes two integer fields at this+8 and this+0xc after FUN_013b2910
                       accepts the stream/context. No safe class/method name is available. */
