...
int __thiscall FUN_014c4070(int *param_1,void *param_2)

{
  ...
  int iVar2;
                    ...
                    /* Deserializes two integer fields and one string field after FUN_013b2910. No
                       owning class is identifiable. */
  ...
  if (extraout_AL != '\0') {
    ...
    if (bVar1) {
      ...
      if (bVar1) {
        ...
        if (bVar1) {
          bVar1 = Deserializer_readString(deserializer,param_1 + 4);
