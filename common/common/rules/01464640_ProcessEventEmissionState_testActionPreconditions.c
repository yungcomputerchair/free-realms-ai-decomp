// addr: 0x01464640
// name: ProcessEventEmissionState_testActionPreconditions
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


byte __thiscall
ProcessEventEmissionState_testActionPreconditions(int param_1,int *param_2,undefined4 param_3)

{
  ...
  undefined4 uStack_4;
                    ...
                    /* Tests action preconditions for ProcessEventEmissionState. */
  uStack_4 = 0xffffffff;
  puStack_8 = &LAB_0169da4b;
