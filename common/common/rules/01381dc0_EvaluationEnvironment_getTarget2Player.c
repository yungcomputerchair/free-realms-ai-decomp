// addr: 0x01381dc0
// name: EvaluationEnvironment_getTarget2Player
// subsystem: common/common/rules
// source (binary assert): common/common/rules/EvaluationEnvironment.cpp
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * EvaluationEnvironment_getTarget2Player(void * env) */

void * __fastcall EvaluationEnvironment_getTarget2Player(void *env)

{
  ...
  int extraout_EDX;
                    ...
                    /* Resolves target2 as a Card and returns the Player owning that card. Returns
                       null when target2 cannot be resolved or cast to Card. */
  if (*(int *)((int)env + 4) == 0) {
  ...
  if (pvVar1 != (void *)0x0) {
    ...
    pvVar1 = find_play_element_in_maps(*(void **)((int)env + 4),*(int *)((int)env + 0x10));
