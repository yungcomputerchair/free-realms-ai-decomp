// addr: 0x01388dc0
// name: EvaluationEnvironment_getTarget2
// subsystem: common/common/rules
// source (binary assert): common/common/rules/EvaluationEnvironment.cpp
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void * EvaluationEnvironment_getTarget2(void * env) */

void * __fastcall EvaluationEnvironment_getTarget2(void *env)

{
  ...
  int iStack_4;
                    ...
                    /* Computes and caches the secondary target by validating target candidates and
                       command-object preconditions against cost rules, then returns the resolved
                       target2 card. */
  iStack_4 = 0xffffffff;
  puStack_8 = &LAB_0168366c;
  local_c = ExceptionList;
  item = (void **)(DAT_01b839d8 ^ (uint)&stack0xffffff1c);
  ExceptionList = &local_c;
  if (*(int *)((int)env + 4) == 0) {
    FUN_012f5a60("mGame","..\\common\\common\\rules\\EvaluationEnvironment.cpp",0x4dd);
    in_EDX = extraout_EDX;
  }
  if (*(int *)((int)env + 0x10) != 0) {
    if (*(int *)((int)env + 4) == 0) {
      FUN_012f5a60("mGame","..\\common\\common\\rules\\EvaluationEnvironment.cpp",0x2bd);
      in_EDX = extraout_EDX_00;
    }
    pvVar2 = find_play_element_in_maps(*(void **)((int)env + 4),in_EDX);
    ExceptionList = local_c;
    return pvVar2;
  }
  ...
  *(undefined1 *)((int)pvVar2 + 8) = 1;
  ...
  if (cVar1 != '\0') {
    iVar3 = (**(code **)(**(int **)((int)env + 4) + 0x128))();
    *(int *)((int)env + 0x10) = iVar3;
    if (iVar3 == 0) {
  ...
  pvVar2 = (void *)((int)env + 0x4c);
  if ((*(int *)((int)env + 0x50) == 0) ||
     (*(int *)((int)env + 0x54) - *(int *)((int)env + 0x50) >> 2 == 0)) goto LAB_0138926c;
  EvaluationEnvironment_ctor();
  iStack_4._0_1_ = 1;
  EvaluationEnvironment_copyFrom(auStack_a0,env,item);
  ...
  ValueDataList_assign(auStack_64,(void *)((int)env + 0x3c));
  ValueDataList_assign(auStack_54,pvVar2);
  pvStack_cc = (void *)0x0;
  uStack_c8 = 0;
  uStack_c4 = 0;
  iStack_4 = CONCAT31(iStack_4._1_3_,2);
  puStack_d4 = *(undefined4 **)((int)env + 0x54);
  uVar8 = extraout_EDX_01;
  if (puStack_d4 < *(undefined4 **)((int)env + 0x50)) {
    FUN_00d83c2d();
    uVar8 = extraout_EDX_02;
  }
  vector = *(undefined4 **)((int)env + 0x50);
  if (*(undefined4 **)((int)env + 0x54) < vector) {
    FUN_00d83c2d();
  ...
  while( true ) {
    ...
    if ((pvVar6 != (void *)0x0) && (*(char *)((int)pvVar6 + 0x44) != '\0')) {
      ...
      EvaluationEnvironment_logCardMessage(env,"Got Target1 Card: ",formatText_00,item);
    }
    cVar1 = FUN_01383520(0x2c,0);
    if (cVar1 == '\0') {
      EvaluationEnvironment_logCardMessage(env,"Checking Costs versus card2: ",formatText,item);
      piVar7 = EvaluationEnvironment_getOriginCard(env);
      uVar5 = *(undefined4 *)(*(int *)((int)env + 4) + 0x20);
      uVar4 = FUN_01383460(2);
      ActionDB_ensureSingleton();
      uVar5 = ActionDB_getAction(uVar4,uVar5);
      ...
      if (cVar1 == '\0') {
        ...
        EvaluationEnvironment_logCardMessage
                  (env,"Card passed cost validation: ",(char *)*vector,item);
        if (*(undefined4 **)((int)env + 0x54) <= vector) {
          FUN_00d83c2d();
        }
  ...
  iVar3 = *(int *)((int)env + 0x50);
  if ((iVar3 != 0) && (*(int *)((int)env + 0x54) - iVar3 >> 2 != 0)) {
    if (iVar3 == 0) {
LAB_01389210:
      FUN_00d83c2d();
    }
    else if (*(int *)((int)env + 0x54) - iVar3 >> 2 == 1) {
      if ((iVar3 == 0) || (*(int *)((int)env + 0x54) - iVar3 >> 2 == 0)) {
        FUN_00d83c2d();
      }
    }
    else if ((iVar3 == 0) || ((uint)(*(int *)((int)env + 0x54) - iVar3 >> 2) < 2))
    goto LAB_01389210;
    uVar5 = PlayElement_getId();
    *(undefined4 *)((int)env + 0x10) = uVar5;
    EvaluationEnvironment_tracef(env,"Returning (%d)",uVar5);
  }
...
LAB_0138926c:
  ...
  pvVar2 = find_play_element_in_maps(*(void **)((int)env + 4),*(int *)((int)env + 0x10));
  iStack_4 = 0xffffffff;
