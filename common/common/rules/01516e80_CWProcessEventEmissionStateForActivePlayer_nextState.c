// addr: 0x01516e80
// name: CWProcessEventEmissionStateForActivePlayer_nextState
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined4 __fastcall CWProcessEventEmissionStateForActivePlayer_nextState(int *param_1)

{
  ...
  while (cVar3 != '\0') {
    if ((param_1[0x42] == 0) ||
      ...
      *(undefined1 *)(param_1 + 0x4e) = 0;
      ...
      piVar5 = (int *)param_1[0x49];
      iVar13 = param_1[0x4a];
      iVar12 = param_1[0x4b];
      set_play_element_id_field((void *)param_1[0x3a],piVar5);
      EvaluationEnvironment_setActionReturn(iVar13);
      set_integer_value_for_key(0x38,iVar12);
      cVar3 = CWProcessEventEmissionStateForActivePlayer_testActionPreconditions(piVar5,iVar13);
      if (cVar3 == '\x01') {
        ...
        if (cVar3 != '\0') {
          ...
          (**(code **)(*piVar5 + 0x154))(0);
          uVar10 = (**(code **)(*param_1 + 0x128))(piVar5,iVar13,iVar12);
          ExceptionList = pvStack_1c;
          return uVar10;
        }
        pcVar14 = "pushing back manual response";
        pvVar6 = (void *)StateMachineState_getGame();
        Game_logGeneral(pvVar6,pcVar14,pvVar4);
        FUN_01336520(param_1 + 0x49);
      }
    }
    cVar3 = (char)param_1[0x4e];
  }
  if (((*(char *)((int)param_1 + 0x131) != '\0') || (param_1[0x46] == 0)) ||
     (iVar12 = param_1[0x47] - param_1[0x46], iVar13 = iVar12 >> 0x1f,
     iVar12 / 0xc + iVar13 == iVar13)) {
    ExceptionList = local_c;
    return 1;
  }
  *(undefined1 *)((int)param_1 + 0x131) = 1;
  ...
  basic_string<char,std::char_traits<char>,std::allocator<char>_>(abStack_44,"pass");
  iStack_4 = 0;
  pbVar9 = (basic_string<char,struct_std::char_traits<char>,class_std::allocator<char>_> *)
           FUN_0145d850(auStack_28,abStack_44);
  iStack_4._0_1_ = 1;
  std::basic_string<char,std::char_traits<char>,std::allocator<char>_>::assign
  ...
  if (uStack_2c < 0x10) {
    ...
    std::basic_string<char,std::char_traits<char>,std::allocator<char>_>::
    basic_string<char,std::char_traits<char>,std::allocator<char>_>(abStack_44,"0");
    iStack_4 = 2;
    pbVar9 = (basic_string<char,struct_std::char_traits<char>,class_std::allocator<char>_> *)
             FUN_0145d850(auStack_28,abStack_44);
    iStack_4._0_1_ = 3;
