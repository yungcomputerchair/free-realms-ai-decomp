// addr: 0x0080bec0
// name: SkyDefinition_sampleFloatTrack14
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


float10 __thiscall SkyDefinition_sampleFloatTrack14(int param_1,void *param_2)

{
  ...
  FloatKeyTree_sampleWrappedPair
            ((void *)(param_1 + 0x26f8),&stack0xfffffff4,param_2,in_stack_fffffff4);
