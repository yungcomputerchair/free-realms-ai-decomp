// addr: 0x01496f10
// name: ModulusNode_evaluate
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool ModulusNode_evaluate(void * this, void * returnValue, void * env) */

bool __thiscall ModulusNode_evaluate(void *this,void *returnValue,void *env)

{
  ...
  int local_4;
                    ...
                    /* Evaluates two integer operands and writes the modulus result when both
                       children are integers. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016a2be0;
  ...
  EvaluationEnvironment_traceEnterf(env,"(Modulus",uVar3);
  puVar8 = local_18;
