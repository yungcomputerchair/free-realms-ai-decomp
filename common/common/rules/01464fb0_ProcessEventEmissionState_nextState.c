// addr: 0x01464fb0
// name: ProcessEventEmissionState_nextState
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined4 __fastcall ProcessEventEmissionState_nextState(int *param_1)

{
  ...
  int iStack_4;
                    ...
                    /* Advances ProcessEventEmissionState, auto-playing actions or pushing a manual
                       response. */
  iStack_4 = 0xffffffff;
  puStack_8 = &LAB_0169dc00;
  ...
  while (cVar3 != '\0') {
    if ((param_1[0x42] == 0) ||
      ...
      *(undefined1 *)(param_1 + 0x4e) = 0;
      ...
      cVar3 = ProcessEventEmissionState_testActionPreconditions(piVar6,iVar13);
      if (cVar3 == '\x01') {
