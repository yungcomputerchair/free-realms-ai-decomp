// addr: 0x0080bc40
// name: SkyDefinition_sampleFloatTrack4
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


float10 __thiscall SkyDefinition_sampleFloatTrack4(int param_1,void *param_2)

{
  ...
  FloatKeyTree_sampleWrappedPair
            ((void *)(param_1 + 0x146c),&stack0xfffffff4,param_2,in_stack_fffffff4);
