// addr: 0x0144dd60
// name: CWProcessEventEmissionState_nextState
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined4 __fastcall CWProcessEventEmissionState_nextState(int *param_1)

{
  ...
  int iStack_4;
                    ...
                    /* Advances CWProcessEventEmissionState, auto-playing accepted actions or
                       pushing a manual response state. */
  iStack_4 = 0xffffffff;
  puStack_8 = &LAB_0169b0e0;
  ...
  while (cVar3 != '\0') {
    if ((param_1[0x42] == 0) ||
      ...
      *(undefined1 *)(param_1 + 0x4e) = 0;
      ...
      cVar3 = CWProcessEventEmissionState_testActionPreconditions(piVar5,iVar13);
      if (cVar3 == '\x01') {
