// addr: 0x0080bcf0
// name: SkyDefinition_sampleFloatTrack6
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


float10 __thiscall SkyDefinition_sampleFloatTrack6(int param_1,void *param_2)

{
  ...
  FloatKeyTree_sampleWrappedPair
            ((void *)(param_1 + 0x17e4),&stack0xfffffff4,param_2,in_stack_fffffff4);
