// addr: 0x0080be60
// name: SkyDefinition_sampleFloatTrack12
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


float10 __thiscall SkyDefinition_sampleFloatTrack12(int param_1,void *param_2)

{
  ...
  FloatKeyTree_sampleWrappedPair
            ((void *)(param_1 + 0x2530),&stack0xfffffff4,param_2,in_stack_fffffff4);
