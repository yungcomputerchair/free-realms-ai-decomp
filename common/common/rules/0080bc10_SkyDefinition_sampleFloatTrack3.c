// addr: 0x0080bc10
// name: SkyDefinition_sampleFloatTrack3
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


float10 __thiscall SkyDefinition_sampleFloatTrack3(int param_1,void *param_2)

{
  ...
  FloatKeyTree_sampleWrappedPair
            ((void *)(param_1 + 5000),&stack0xfffffff4,param_2,in_stack_fffffff4);
