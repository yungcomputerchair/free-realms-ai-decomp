// addr: 0x0080be00
// name: SkyDefinition_sampleFloatTrack10
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


float10 __thiscall SkyDefinition_sampleFloatTrack10(int param_1,void *param_2)

{
  ...
  FloatKeyTree_sampleWrappedPair
            ((void *)(param_1 + 0x1d24),&stack0xfffffff4,param_2,in_stack_fffffff4);
