// addr: 0x01383e90
// name: Rules_getVariable7Card
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* Setting prototype: void * Rules_getVariable7Card(void) */

void * Rules_getVariable7Card(void)

{
  ...
  undefined4 uVar5;
                    ...
                    /* Fetches rules variable 7, unwraps it, and dynamic-casts it from PlayElement
                       to Card. */
  uVar5 = 0;
