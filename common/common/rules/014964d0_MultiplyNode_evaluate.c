// addr: 0x014964d0
// name: MultiplyNode_evaluate
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool MultiplyNode_evaluate(void * this, void * returnValue, void * env) */

bool __thiscall MultiplyNode_evaluate(void *this,void *returnValue,void *env)

{
  ...
  int local_4;
                    ...
                    /* Evaluates two integer operands and writes their product when both child
                       evaluations succeed. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016a29f0;
  ...
  EvaluationEnvironment_traceEnterf(env,"(Multiply",uVar3);
  puVar8 = local_18;
