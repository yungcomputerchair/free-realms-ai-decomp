// addr: 0x0149d760
// name: AddNode_evaluate
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: bool AddNode_evaluate(void * this, void * returnValue, void * env) */

bool __thiscall AddNode_evaluate(void *this,void *returnValue,void *env)

{
  ...
  int local_4;
                    ...
                    /* Evaluates two integer operands and writes their sum when both child
                       evaluations succeed. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016a3fa0;
  ...
  EvaluationEnvironment_traceEnterf(env,"(add",uVar3);
  puVar8 = local_18;
