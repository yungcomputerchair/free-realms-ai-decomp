...
CommandObject_AlternateMultiAction_ctor
...

{
  ...
  int local_4;
                    ...
                    /* Constructs CommandObject_AlternateMultiAction with action/player/origin
                       return values. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b61e3;
  local_c = ExceptionList;
  uVar2 = DAT_01b839d8 ^ (uint)&stack0xffffffe4;
  ExceptionList = &local_c;
  CommandObject_ctor(param_1,param_6);
  local_4 = 0;
  *param_1 = CommandObject_AlternateMultiAction::vftable;
  param_1[2] = CommandObject_AlternateMultiAction::vftable;
  ...
  *(undefined1 *)((int)param_1 + 0x81) = 0;
  param_1[0x47] = 0x113;
  pvVar3 = EvaluationEnvironment_getOriginCard(param_6);
  param_1[0x19] = pvVar3;
  ...
  uVar4 = 0;
  pvVar3 = CommandObject_getActionFromEnvironment(param_6);
  if (pvVar3 != (void *)0x0) {
    CommandObject_getActionFromEnvironment(param_6);
    uVar4 = FUN_01321f20();
  }
  ReturnValueMap_setInteger(5,uVar4);
  FUN_014181b0(0xb,param_2);
  FUN_014181b0(0xc,param_3);
  FUN_014181b0(0xd,param_4);
  FUN_014181b0(0x27,param_5);
