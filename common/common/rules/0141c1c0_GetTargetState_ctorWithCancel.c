// addr: 0x0141c1c0
// name: GetTargetState_ctorWithCancel
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


undefined4 * __thiscall
GetTargetState_ctorWithCancel(undefined4 *param_1,undefined4 param_2,void *param_3)

{
  ...
  undefined4 local_4;
                    ...
                    /* Constructs a GetTargetState variant with cancel text and copied target/value
                       data. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_01693d22;
