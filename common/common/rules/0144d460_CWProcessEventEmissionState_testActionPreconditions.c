// addr: 0x0144d460
// name: CWProcessEventEmissionState_testActionPreconditions
// subsystem: common/common/rules
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


byte __thiscall
CWProcessEventEmissionState_testActionPreconditions(int param_1,int *param_2,undefined4 param_3)

{
  ...
  undefined4 uStack_4;
                    ...
                    /* Tests action preconditions for CWProcessEventEmissionState using
                       player/action ids. */
  uStack_4 = 0xffffffff;
  puStack_8 = &LAB_0169af3b;
  ...
  pcVar7 = "CWProcessEventEmissionState::testActionPreconitions(%d, %d - %d)";
