...
CommandObject_CustomChoiceDialog_ctor
...

{
  ...
  int local_4;
                    ...
                    /* Constructs a CustomChoiceDialog command object with return-map/player/action
                       context. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b5c93;
  ...
  *(undefined1 *)((int)param_1 + 0x81) = 0;
  ...
  param_1[0x1c] = uVar4;
  uVar4 = 0;
  pvVar3 = EvaluationEnvironment_getMember14(param_6);
  if (pvVar3 == (void *)0x0) {
    pvVar3 = Game_getCurrentTurn((void *)param_1[0xc]);
    uVar2 = get_field_8(pvVar3);
    if (uVar2 == 0) goto LAB_0150bf55;
    pvVar3 = Game_getCurrentTurn((void *)param_1[0xc]);
    get_field_8(pvVar3);
  }
  else {
