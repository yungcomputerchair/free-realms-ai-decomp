...
CommandObject_ChainedAction_ctor(undefined4 *param_1,undefined4 param_2,void *param_3)

{
  ...
  int local_4;
                    ...
                    /* Constructs CommandObject_ChainedAction with action/player/origin return
                       values. */
  local_4 = 0xffffffff;
  puStack_8 = &LAB_016b5fa3;
  local_c = ExceptionList;
  uVar2 = DAT_01b839d8 ^ (uint)&stack0xffffffe0;
  ExceptionList = &local_c;
  CommandObject_ctor(param_1,param_3);
  local_4 = 0;
  *param_1 = CommandObject_ChainedAction::vftable;
  param_1[2] = CommandObject_ChainedAction::vftable;
  ...
  *(undefined1 *)((int)param_1 + 0x81) = 0;
  ...
  pvVar3 = EvaluationEnvironment_getOriginCard(param_3);
  if (pvVar3 != (void *)0x0) {
    EvaluationEnvironment_getOriginCard(param_3);
    uVar4 = PlayElement_getId();
  }
  ReturnValueMap_setInteger(3,uVar4);
  uVar4 = 0;
  pvVar3 = CommandObject_getActionFromEnvironment(param_3);
  if (pvVar3 != (void *)0x0) {
    CommandObject_getActionFromEnvironment(param_3);
    uVar4 = FUN_01321f20();
  }
  ReturnValueMap_setInteger(5,uVar4);
  FUN_014181b0(0x12,param_2);
