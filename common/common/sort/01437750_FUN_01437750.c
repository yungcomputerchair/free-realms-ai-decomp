...
void __thiscall
FUN_01437750(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,int param_7)

{
  ...
  if (uVar6 != 0) {
    ...
    if (local_18 < iVar4 + uVar6) {
      ...
      local_1c = FUN_012b0ab0(local_18);
      iVar4 = param_3;
      local_8 = 0;
      uVar3 = FUN_012b3560(*(undefined4 *)(param_1 + 4),param_3,local_1c);
      uVar3 = FUN_01437280(param_4,param_5,param_6,param_7,uVar3);
      FUN_012b3560(iVar4,*(undefined4 *)(param_1 + 8),uVar3);
      local_8 = 0xffffffff;
    ...
    if ((uint)((int)(local_1c - param_3) >> 2) < uVar6) {
      FUN_012b3560(param_3,*(undefined4 *)(param_1 + 8),uVar6 * 4 + param_3);
      local_28 = param_4;
      local_24 = param_5;
      puVar8 = &param_2;
      FUN_012b1950(local_20);
      uVar3 = FUN_012b0b90(puVar8);
      FUN_01436a50(&local_28,uVar3);
      local_8 = 2;
      FUN_01437280(local_28,local_24,param_6,param_7,*(undefined4 *)(param_1 + 8));
      local_8 = 0xffffffff;
      *(int *)(param_1 + 8) = *(int *)(param_1 + 8) + uVar6 * 4;
      FUN_01436d80(param_4,param_5,local_28,local_24,iVar4);
      ExceptionList = local_10;
      return;
    }
    iVar5 = *(int *)(param_1 + 8);
    param_3 = iVar5 + local_24 * -4;
    uVar3 = FUN_012b3560(param_3,iVar5,iVar5);
    *(undefined4 *)(param_1 + 8) = uVar3;
    FUN_012b21a0(iVar4,param_3,iVar5);
    FUN_01436d80(param_4,param_5,param_6,param_7,iVar4);
  }
  ExceptionList = local_10;
  return;
}
