...

{
  ...
  if ((local_8 & 1) == 0) {
    ...
    *piVar4 = *piVar4 + -1;
    if (*piVar4 == 0) {
      if (DAT_01bf3d2c != (uint *)0x0) {
        VirtualFree((LPVOID)(DAT_01cbef88 * 0x8000 + DAT_01bf3d2c[3]),0x8000,0x4000);
        DAT_01bf3d2c[2] = DAT_01bf3d2c[2] | 0x80000000U >> ((byte)DAT_01cbef88 & 0x1f);
        *(undefined4 *)(DAT_01bf3d2c[4] + 0xc4 + DAT_01cbef88 * 4) = 0;
        *(char *)(DAT_01bf3d2c[4] + 0x43) = *(char *)(DAT_01bf3d2c[4] + 0x43) + -1;
        if (*(char *)(DAT_01bf3d2c[4] + 0x43) == '\0') {
          DAT_01bf3d2c[1] = DAT_01bf3d2c[1] & 0xfffffffe;
        }
        if (DAT_01bf3d2c[2] == 0xffffffff) {
          VirtualFree((LPVOID)DAT_01bf3d2c[3],0,0x8000);
          HeapFree(DAT_01bf3c5c,0,(LPVOID)DAT_01bf3d2c[4]);
          _memmove(DAT_01bf3d2c,DAT_01bf3d2c + 5,
                   (DAT_01cbef74 * 0x14 - (int)DAT_01bf3d2c) + -0x14 + DAT_01cbef78);
          DAT_01cbef74 = DAT_01cbef74 + -1;
          if (DAT_01bf3d2c < param_1) {
            param_1 = param_1 + -5;
          }
          DAT_01cbef80 = DAT_01cbef78;
        }
      }
      DAT_01bf3d2c = param_1;
      DAT_01cbef88 = uVar14;
    }
  }
  return;
