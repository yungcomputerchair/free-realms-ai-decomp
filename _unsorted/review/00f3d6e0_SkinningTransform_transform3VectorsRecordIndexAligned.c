// addr: 0x00f3d6e0
// name: SkinningTransform_transform3VectorsRecordIndexAligned
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void SkinningTransform_transform3VectorsRecordIndexAligned(int count_, float *
   src, void * dst, void * matrixOrRemap, int matrixBase_) */

void __cdecl
SkinningTransform_transform3VectorsRecordIndexAligned
...

{
  ...
  int in_stack_0000001c;
                    ...
                    /* Implements the aligned fast path using the record-embedded matrix index for
                       3-vector skinning; if the matrix base is unaligned it delegates to existing
                       fallback at 00f36e60. */
