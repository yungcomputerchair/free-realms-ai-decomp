// addr: 0x00f3d010
// name: SkinningTransform_transform4VectorsIndexedAligned
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void SkinningTransform_transform4VectorsIndexedAligned(int count_, float *
   src, void * dst, void * matrixOrRemap, int matrixBase_) */

void __cdecl
SkinningTransform_transform4VectorsIndexedAligned
...

{
  ...
  int in_stack_00000020;
                    ...
                    /* Implements the aligned fast path for indexed 4-vector skinning transform; if
                       the matrix base is unaligned it delegates to existing fallback at 00f367b0.
                        */
