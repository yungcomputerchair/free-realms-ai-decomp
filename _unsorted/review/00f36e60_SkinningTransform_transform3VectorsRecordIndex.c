// addr: 0x00f36e60
// name: SkinningTransform_transform3VectorsRecordIndex
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void SkinningTransform_transform3VectorsRecordIndex(int count_, void * src,
   void * dst, float * matrixPalette, int extraFloatCount_, int srcStride_, int dstStride_) */

void __cdecl
SkinningTransform_transform3VectorsRecordIndex
...

{
  ...
  int iVar6;
                    ...
                    /* Transforms records containing position and two vectors by the palette matrix
                       whose index is stored in the record, copying optional extra attributes. */
  if (count_ != 0) {
    ...
    do {
      ...
      pfVar5[-2] = pfVar2[4] * pfVar4[-1] + *pfVar2 * pfVar4[-2] + pfVar2[8] * *pfVar4 + pfVar2[0xc]
      ;
      pfVar5[-1] = pfVar2[5] * pfVar4[-1] + pfVar2[1] * pfVar4[-2] + pfVar2[9] * *pfVar4 +
                   pfVar2[0xd];
      *pfVar5 = pfVar2[6] * pfVar4[-1] + pfVar4[-2] * pfVar2[2] + pfVar2[10] * *pfVar4 + pfVar2[0xe]
      ;
      pfVar5[1] = pfVar2[4] * pfVar4[3] + pfVar2[8] * pfVar4[4] + pfVar4[2] * *pfVar2;
      ...
      pfVar5[4] = pfVar2[4] * pfVar4[6] + pfVar2[8] * pfVar4[7] + pfVar4[5] * *pfVar2;
