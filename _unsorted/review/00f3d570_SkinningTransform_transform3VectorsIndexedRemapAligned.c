// addr: 0x00f3d570
// name: SkinningTransform_transform3VectorsIndexedRemapAligned
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void SkinningTransform_transform3VectorsIndexedRemapAligned(int count_, float
   * src, void * dst, void * matrixOrRemap, int matrixBase_) */

void __cdecl
SkinningTransform_transform3VectorsIndexedRemapAligned
...

{
  ...
  int in_stack_00000020;
                    ...
                    /* Implements the aligned fast path for remapped-index 3-vector skinning
