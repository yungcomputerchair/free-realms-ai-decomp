// addr: 0x00f3e280
// name: SkinningTransform_blend2Matrices4VectorsAligned
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Setting prototype: void SkinningTransform_blend2Matrices4VectorsAligned(int count_, float * src,
   void * dst, void * matrixOrRemap, int matrixBase_) */

void __cdecl
SkinningTransform_blend2Matrices4VectorsAligned
...

{
  ...
  int in_stack_00000020;
                    ...
                    /* Implements the aligned fast path blending two matrices for 4-vector skinning;
  ...
  if ((matrixBase_ & 0xfU) == 0) {
    for (; count_ != 0; count_ = count_ + -1) {
      ...
      *(ulonglong *)((int)dst + 0x24) =
           CONCAT44(fVar4 * fVar16 + fVar5 * fVar19 + fVar6 * fVar22,
                    fVar4 * fVar15 + fVar5 * fVar18 + fVar6 * fVar21);
      *(float *)((int)dst + 0x2c) = fVar4 * fVar17 + fVar5 * fVar20 + fVar6 * fVar23;
