// addr: 0x00f380c0
// name: SkinningTransform_blend2Matrices4Vectors
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Setting prototype: void SkinningTransform_blend2Matrices4Vectors(int count_, void * src, void *
   dst, int * remap, float * matrixPalette, int extraFloatCount_, int srcStride_, int dstStride_) */

void __cdecl
SkinningTransform_blend2Matrices4Vectors
...

{
  ...
  int iVar7;
                    ...
                    /* Blends two matrix-palette entries using byte weights, transforms position
                       plus three direction vectors, and copies extra vertex attributes. */
  if (count_ != 0) {
    ...
    do {
      ...
      pfVar6[-2] = _DAT_01c00cb8 +
                   _DAT_01c00ca8 * *(float *)(pbVar3 + -4) +
                   *(float *)(pbVar3 + -0xc) * _DAT_01c00c88 +
                   *(float *)(pbVar3 + -8) * _DAT_01c00c98;
      pfVar6[-1] = *(float *)(pbVar3 + -8) * _DAT_01c00c9c +
                   *(float *)(pbVar3 + -4) * _DAT_01c00cac +
                   *(float *)(pbVar3 + -0xc) * _DAT_01c00c8c + _DAT_01c00cbc;
      *pfVar6 = *(float *)(pbVar3 + -8) * _DAT_01c00ca0 +
                *(float *)(pbVar3 + -4) * _DAT_01c00cb0 + *(float *)(pbVar3 + -0xc) * _DAT_01c00c90
                + _DAT_01c00cc0;
      pfVar6[1] = _DAT_01c00c88 * *(float *)(pbVar3 + 4) +
                  *(float *)(pbVar3 + 8) * _DAT_01c00c98 + *(float *)(pbVar3 + 0xc) * _DAT_01c00ca8;
      pfVar6[2] = _DAT_01c00c8c * *(float *)(pbVar3 + 4) +
                  *(float *)(pbVar3 + 8) * _DAT_01c00c9c + *(float *)(pbVar3 + 0xc) * _DAT_01c00cac;
      pfVar6[3] = _DAT_01c00c90 * *(float *)(pbVar3 + 4) +
                  *(float *)(pbVar3 + 8) * _DAT_01c00ca0 + *(float *)(pbVar3 + 0xc) * _DAT_01c00cb0;
      pfVar6[4] = *(float *)(pbVar3 + 0x10) * _DAT_01c00c88 +
                  *(float *)(pbVar3 + 0x14) * _DAT_01c00c98 +
                  *(float *)(pbVar3 + 0x18) * _DAT_01c00ca8;
      pfVar6[5] = *(float *)(pbVar3 + 0x10) * _DAT_01c00c8c +
                  *(float *)(pbVar3 + 0x14) * _DAT_01c00c9c +
                  *(float *)(pbVar3 + 0x18) * _DAT_01c00cac;
      pfVar6[6] = *(float *)(pbVar3 + 0x10) * _DAT_01c00c90 +
                  *(float *)(pbVar3 + 0x14) * _DAT_01c00ca0 +
                  *(float *)(pbVar3 + 0x18) * _DAT_01c00cb0;
      pfVar6[7] = *(float *)(pbVar3 + 0x1c) * _DAT_01c00c88 +
                  *(float *)(pbVar3 + 0x20) * _DAT_01c00c98 +
                  *(float *)(pbVar3 + 0x24) * _DAT_01c00ca8;
      pfVar6[8] = *(float *)(pbVar3 + 0x1c) * _DAT_01c00c8c +
                  *(float *)(pbVar3 + 0x20) * _DAT_01c00c9c +
                  *(float *)(pbVar3 + 0x24) * _DAT_01c00cac;
      pbVar5 = pbVar3 + 0x28;
      pfVar6[9] = *(float *)(pbVar3 + 0x1c) * _DAT_01c00c90 +
                  *(float *)(pbVar3 + 0x20) * _DAT_01c00ca0 +
                  *(float *)(pbVar3 + 0x24) * _DAT_01c00cb0;
      if (extraFloatCount_ != 0) {
        iVar2 = 0x28 - (int)pbVar5;
