// addr: 0x00f3cec0
// name: SkinningTransform_transform3VectorsSingleMatrixAligned
// subsystem: common/review
// Decompiled pseudo-C from FreeRealms.exe (Ghidra). First-party.


/* Setting prototype: void SkinningTransform_transform3VectorsSingleMatrixAligned(int count_, float
   * src, void * dst, void * matrixOrRemap, int matrixBase_) */

void __cdecl
SkinningTransform_transform3VectorsSingleMatrixAligned
...

{
  ...
  int in_stack_0000001c;
                    ...
                    /* Implements the aligned fast path for single-matrix 3-vector skinning
